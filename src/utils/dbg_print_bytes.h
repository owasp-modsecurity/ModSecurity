#ifndef DBG_PRINT_BYTES_HPP
#define DBG_PRINT_BYTES_HPP
 ...
 *
 * @param dest       Output buffer. If nullptr, returns 0 without doing anything.
 * @param dest_size  Size of the output buffer in bytes. If 0, returns 0.
 * @param src        Input byte sequence. If nullptr or src_len is 0, treated as empty.
 ...
 *                   truncation occurs. If nullptr, defaults to "...".
...
std::size_t dbg_print_bytes(char *dest, std::size_t dest_size,
                            ...
                            const char *omit = nullptr) noexcept;

#endif /* DBG_PRINT_BYTES_HPP */
