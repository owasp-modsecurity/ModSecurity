...
#ifndef SRC_VARIABLES_VARIABLE_RUN_TIME_RESOLUTION_H_
#define SRC_VARIABLES_VARIABLE_RUN_TIME_RESOLUTION_H_
...
class VariableRunTimeResolution {
    /**
     * FIXME: This list should be dynamic generated.
     *        There should be an register method while the variable is created.
     * 
     */
 public:
...
#endif  // SRC_VARIABLES_VARIABLE_RUN_TIME_RESOLUTION_H_
