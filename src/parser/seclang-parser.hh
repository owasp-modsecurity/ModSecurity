...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_SETVAR_OPERATION_EQUALS_APPEND = 358, // SETVAR_OPERATION_EQUALS_APPEND
    TOK_SETVAR_OPERATION_EQUALS_PREPEND = 359, // SETVAR_OPERATION_EQUALS_PREPEND
    TOK_NOT = 360,                 // "NOT"
    TOK_OPERATOR_BEGINS_WITH = 361, // "OPERATOR_BEGINS_WITH"
    TOK_OPERATOR_CONTAINS = 362,   // "OPERATOR_CONTAINS"
    TOK_OPERATOR_CONTAINS_WORD = 363, // "OPERATOR_CONTAINS_WORD"
    TOK_OPERATOR_DETECT_SQLI = 364, // "OPERATOR_DETECT_SQLI"
    TOK_OPERATOR_DETECT_XSS = 365, // "OPERATOR_DETECT_XSS"
    TOK_OPERATOR_ENDS_WITH = 366,  // "OPERATOR_ENDS_WITH"
    TOK_OPERATOR_EQ = 367,         // "OPERATOR_EQ"
    TOK_OPERATOR_FUZZY_HASH = 368, // "OPERATOR_FUZZY_HASH"
    TOK_OPERATOR_GEOLOOKUP = 369,  // "OPERATOR_GEOLOOKUP"
    TOK_OPERATOR_GE = 370,         // "OPERATOR_GE"
    TOK_OPERATOR_GSB_LOOKUP = 371, // "OPERATOR_GSB_LOOKUP"
    TOK_OPERATOR_GT = 372,         // "OPERATOR_GT"
    TOK_OPERATOR_INSPECT_FILE = 373, // "OPERATOR_INSPECT_FILE"
    TOK_OPERATOR_IP_MATCH_FROM_FILE = 374, // "OPERATOR_IP_MATCH_FROM_FILE"
    TOK_OPERATOR_IP_MATCH = 375,   // "OPERATOR_IP_MATCH"
    TOK_OPERATOR_LE = 376,         // "OPERATOR_LE"
    TOK_OPERATOR_LT = 377,         // "OPERATOR_LT"
    TOK_OPERATOR_PM_FROM_FILE = 378, // "OPERATOR_PM_FROM_FILE"
    TOK_OPERATOR_PM = 379,         // "OPERATOR_PM"
    TOK_OPERATOR_RBL = 380,        // "OPERATOR_RBL"
    TOK_OPERATOR_RSUB = 381,       // "OPERATOR_RSUB"
    TOK_OPERATOR_RX_CONTENT_ONLY = 382, // "Operator RX (content only)"
    TOK_OPERATOR_RX = 383,         // "OPERATOR_RX"
    TOK_OPERATOR_RX_GLOBAL = 384,  // "OPERATOR_RX_GLOBAL"
    TOK_OPERATOR_STR_EQ = 385,     // "OPERATOR_STR_EQ"
    TOK_OPERATOR_STR_MATCH = 386,  // "OPERATOR_STR_MATCH"
    TOK_OPERATOR_UNCONDITIONAL_MATCH = 387, // "OPERATOR_UNCONDITIONAL_MATCH"
    TOK_OPERATOR_VALIDATE_BYTE_RANGE = 388, // "OPERATOR_VALIDATE_BYTE_RANGE"
    TOK_OPERATOR_VALIDATE_DTD = 389, // "OPERATOR_VALIDATE_DTD"
    TOK_OPERATOR_VALIDATE_HASH = 390, // "OPERATOR_VALIDATE_HASH"
    TOK_OPERATOR_VALIDATE_SCHEMA = 391, // "OPERATOR_VALIDATE_SCHEMA"
    TOK_OPERATOR_VALIDATE_URL_ENCODING = 392, // "OPERATOR_VALIDATE_URL_ENCODING"
    TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 393, // "OPERATOR_VALIDATE_UTF8_ENCODING"
    TOK_OPERATOR_VERIFY_CC = 394,  // "OPERATOR_VERIFY_CC"
    TOK_OPERATOR_VERIFY_CPF = 395, // "OPERATOR_VERIFY_CPF"
    TOK_OPERATOR_VERIFY_SSN = 396, // "OPERATOR_VERIFY_SSN"
    TOK_OPERATOR_VERIFY_SVNR = 397, // "OPERATOR_VERIFY_SVNR"
    TOK_OPERATOR_WITHIN = 398,     // "OPERATOR_WITHIN"
    TOK_CONFIG_DIR_AUDIT_LOG_FMT = 399, // CONFIG_DIR_AUDIT_LOG_FMT
    TOK_JSON = 400,                // JSON
    TOK_NATIVE = 401,              // NATIVE
    TOK_ACTION_CTL_RULE_ENGINE = 402, // "ACTION_CTL_RULE_ENGINE"
    TOK_ACTION_ACCURACY = 403,     // "Accuracy"
    TOK_ACTION_ALLOW = 404,        // "Allow"
    TOK_ACTION_APPEND = 405,       // "Append"
    TOK_ACTION_AUDIT_LOG = 406,    // "AuditLog"
    TOK_ACTION_BLOCK = 407,        // "Block"
    TOK_ACTION_CAPTURE = 408,      // "Capture"
    TOK_ACTION_CHAIN = 409,        // "Chain"
    TOK_ACTION_CTL_AUDIT_ENGINE = 410, // "ACTION_CTL_AUDIT_ENGINE"
    TOK_ACTION_CTL_AUDIT_LOG_PARTS = 411, // "ACTION_CTL_AUDIT_LOG_PARTS"
    TOK_ACTION_CTL_BDY_JSON = 412, // "ACTION_CTL_BDY_JSON"
    TOK_ACTION_CTL_BDY_XML = 413,  // "ACTION_CTL_BDY_XML"
    TOK_ACTION_CTL_BDY_URLENCODED = 414, // "ACTION_CTL_BDY_URLENCODED"
    TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 415, // "ACTION_CTL_FORCE_REQ_BODY_VAR"
    TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 416, // "ACTION_CTL_REQUEST_BODY_ACCESS"
    TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 417, // "ACTION_CTL_RULE_REMOVE_BY_ID"
    TOK_ACTION_CTL_RULE_REMOVE_BY_TAG = 418, // "ACTION_CTL_RULE_REMOVE_BY_TAG"
    TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 419, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_ID"
    TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 420, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG"
    TOK_ACTION_DENY = 421,         // "Deny"
    TOK_ACTION_DEPRECATE_VAR = 422, // "DeprecateVar"
    TOK_ACTION_DROP = 423,         // "Drop"
    TOK_ACTION_EXEC = 424,         // "Exec"
    TOK_ACTION_EXPIRE_VAR = 425,   // "ExpireVar"
    TOK_ACTION_ID = 426,           // "Id"
    TOK_ACTION_INITCOL = 427,      // "InitCol"
    TOK_ACTION_LOG = 428,          // "Log"
    TOK_ACTION_LOG_DATA = 429,     // "LogData"
    TOK_ACTION_MATURITY = 430,     // "Maturity"
    TOK_ACTION_MSG = 431,          // "Msg"
    TOK_ACTION_MULTI_MATCH = 432,  // "MultiMatch"
    TOK_ACTION_NO_AUDIT_LOG = 433, // "NoAuditLog"
    TOK_ACTION_NO_LOG = 434,       // "NoLog"
    TOK_ACTION_PASS = 435,         // "Pass"
    TOK_ACTION_PAUSE = 436,        // "Pause"
    TOK_ACTION_PHASE = 437,        // "Phase"
    TOK_ACTION_PREPEND = 438,      // "Prepend"
    TOK_ACTION_PROXY = 439,        // "Proxy"
    TOK_ACTION_REDIRECT = 440,     // "Redirect"
    TOK_ACTION_REV = 441,          // "Rev"
    TOK_ACTION_SANITISE_ARG = 442, // "SanitiseArg"
    TOK_ACTION_SANITISE_MATCHED = 443, // "SanitiseMatched"
    TOK_ACTION_SANITISE_MATCHED_BYTES = 444, // "SanitiseMatchedBytes"
    TOK_ACTION_SANITISE_REQUEST_HEADER = 445, // "SanitiseRequestHeader"
    TOK_ACTION_SANITISE_RESPONSE_HEADER = 446, // "SanitiseResponseHeader"
    TOK_ACTION_SETENV = 447,       // "SetEnv"
    TOK_ACTION_SETRSC = 448,       // "SetRsc"
    TOK_ACTION_SETSID = 449,       // "SetSid"
    TOK_ACTION_SETUID = 450,       // "SetUID"
    TOK_ACTION_SEVERITY = 451,     // "Severity"
    TOK_ACTION_SKIP = 452,         // "Skip"
    TOK_ACTION_SKIP_AFTER = 453,   // "SkipAfter"
    TOK_ACTION_STATUS = 454,       // "Status"
    TOK_ACTION_TAG = 455,          // "Tag"
    TOK_ACTION_TRANSFORMATION_BASE_64_ENCODE = 456, // "ACTION_TRANSFORMATION_BASE_64_ENCODE"
    TOK_ACTION_TRANSFORMATION_BASE_64_DECODE = 457, // "ACTION_TRANSFORMATION_BASE_64_DECODE"
    TOK_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 458, // "ACTION_TRANSFORMATION_BASE_64_DECODE_EXT"
    TOK_ACTION_TRANSFORMATION_CMD_LINE = 459, // "ACTION_TRANSFORMATION_CMD_LINE"
    TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 460, // "ACTION_TRANSFORMATION_COMPRESS_WHITESPACE"
    TOK_ACTION_TRANSFORMATION_CSS_DECODE = 461, // "ACTION_TRANSFORMATION_CSS_DECODE"
    TOK_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 462, // "ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE"
    TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 463, // "ACTION_TRANSFORMATION_HEX_ENCODE"
    TOK_ACTION_TRANSFORMATION_HEX_DECODE = 464, // "ACTION_TRANSFORMATION_HEX_DECODE"
    TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 465, // "ACTION_TRANSFORMATION_HTML_ENTITY_DECODE"
    TOK_ACTION_TRANSFORMATION_JS_DECODE = 466, // "ACTION_TRANSFORMATION_JS_DECODE"
    TOK_ACTION_TRANSFORMATION_LENGTH = 467, // "ACTION_TRANSFORMATION_LENGTH"
    TOK_ACTION_TRANSFORMATION_LOWERCASE = 468, // "ACTION_TRANSFORMATION_LOWERCASE"
    TOK_ACTION_TRANSFORMATION_PHP_ARGS_NAMES = 469, // "ACTION_TRANSFORMATION_PHP_ARGS_NAMES"
    ...
    TOK_CONFIG_DIR_REQ_BODY = 528, // "CONFIG_DIR_REQ_BODY"
    TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 529, // "CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT"
    TOK_CONFIG_DIR_REQ_BODY_LIMIT = 530, // "CONFIG_DIR_REQ_BODY_LIMIT"
    TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 531, // "CONFIG_DIR_REQ_BODY_LIMIT_ACTION"
    TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 532, // "CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT"
    TOK_CONFIG_DIR_RES_BODY = 533, // "CONFIG_DIR_RES_BODY"
    TOK_CONFIG_DIR_RES_BODY_LIMIT = 534, // "CONFIG_DIR_RES_BODY_LIMIT"
    TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 535, // "CONFIG_DIR_RES_BODY_LIMIT_ACTION"
    TOK_CONFIG_SEC_RULE_INHERITANCE = 536, // "CONFIG_SEC_RULE_INHERITANCE"
    TOK_CONFIG_SEC_RULE_PERF_TIME = 537, // "CONFIG_SEC_RULE_PERF_TIME"
    TOK_CONFIG_DIR_RULE_ENG = 538, // "CONFIG_DIR_RULE_ENG"
    TOK_CONFIG_DIR_SEC_ACTION = 539, // "CONFIG_DIR_SEC_ACTION"
    TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 540, // "CONFIG_DIR_SEC_DEFAULT_ACTION"
    TOK_CONFIG_DIR_SEC_MARKER = 541, // "CONFIG_DIR_SEC_MARKER"
    TOK_CONFIG_DIR_UNICODE_MAP_FILE = 542, // "CONFIG_DIR_UNICODE_MAP_FILE"
    TOK_CONFIG_DIR_UNICODE_CODE_PAGE = 543, // "CONFIG_DIR_UNICODE_CODE_PAGE"
    TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 544, // "CONFIG_SEC_COLLECTION_TIMEOUT"
    TOK_CONFIG_SEC_HTTP_BLKEY = 545, // "CONFIG_SEC_HTTP_BLKEY"
    TOK_CONFIG_SEC_INTERCEPT_ON_ERROR = 546, // "CONFIG_SEC_INTERCEPT_ON_ERROR"
    TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 547, // "CONFIG_SEC_REMOTE_RULES_FAIL_ACTION"
    TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 548, // "CONFIG_SEC_RULE_REMOVE_BY_ID"
    TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 549, // "CONFIG_SEC_RULE_REMOVE_BY_MSG"
    TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 550, // "CONFIG_SEC_RULE_REMOVE_BY_TAG"
    TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 551, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG"
    TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 552, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG"
    TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 553, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID"
    TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 554, // "CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID"
    TOK_CONFIG_UPDLOAD_KEEP_FILES = 555, // "CONFIG_UPDLOAD_KEEP_FILES"
    TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 556, // "CONFIG_UPDLOAD_SAVE_TMP_FILES"
    TOK_CONFIG_UPLOAD_DIR = 557,   // "CONFIG_UPLOAD_DIR"
    TOK_CONFIG_UPLOAD_FILE_LIMIT = 558, // "CONFIG_UPLOAD_FILE_LIMIT"
    TOK_CONFIG_UPLOAD_FILE_MODE = 559, // "CONFIG_UPLOAD_FILE_MODE"
    TOK_CONFIG_VALUE_ABORT = 560,  // "CONFIG_VALUE_ABORT"
    TOK_CONFIG_VALUE_DETC = 561,   // "CONFIG_VALUE_DETC"
    TOK_CONFIG_VALUE_HTTPS = 562,  // "CONFIG_VALUE_HTTPS"
    TOK_CONFIG_VALUE_OFF = 563,    // "CONFIG_VALUE_OFF"
    TOK_CONFIG_VALUE_ON = 564,     // "CONFIG_VALUE_ON"
    TOK_CONFIG_VALUE_PARALLEL = 565, // "CONFIG_VALUE_PARALLEL"
    TOK_CONFIG_VALUE_PROCESS_PARTIAL = 566, // "CONFIG_VALUE_PROCESS_PARTIAL"
    TOK_CONFIG_VALUE_REJECT = 567, // "CONFIG_VALUE_REJECT"
    TOK_CONFIG_VALUE_RELEVANT_ONLY = 568, // "CONFIG_VALUE_RELEVANT_ONLY"
    TOK_CONFIG_VALUE_SERIAL = 569, // "CONFIG_VALUE_SERIAL"
    TOK_CONFIG_VALUE_WARN = 570,   // "CONFIG_VALUE_WARN"
    TOK_CONFIG_XML_EXTERNAL_ENTITY = 571, // "CONFIG_XML_EXTERNAL_ENTITY"
    TOK_CONGIG_DIR_RESPONSE_BODY_MP = 572, // "CONGIG_DIR_RESPONSE_BODY_MP"
    TOK_CONGIG_DIR_SEC_ARG_SEP = 573, // "CONGIG_DIR_SEC_ARG_SEP"
    TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 574, // "CONGIG_DIR_SEC_COOKIE_FORMAT"
    TOK_CONFIG_SEC_COOKIEV0_SEPARATOR = 575, // "CONFIG_SEC_COOKIEV0_SEPARATOR"
    TOK_CONGIG_DIR_SEC_DATA_DIR = 576, // "CONGIG_DIR_SEC_DATA_DIR"
    TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 577, // "CONGIG_DIR_SEC_STATUS_ENGINE"
    TOK_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 578, // "CONFIG_SEC_STREAM_IN_BODY_INSPECTION"
    TOK_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 579, // "CONFIG_SEC_STREAM_OUT_BODY_INSPECTION"
    TOK_CONGIG_DIR_SEC_TMP_DIR = 580, // "CONGIG_DIR_SEC_TMP_DIR"
    TOK_DIRECTIVE = 581,           // "DIRECTIVE"
    TOK_DIRECTIVE_SECRULESCRIPT = 582, // "DIRECTIVE_SECRULESCRIPT"
    TOK_FREE_TEXT_QUOTE_MACRO_EXPANSION = 583, // "FREE_TEXT_QUOTE_MACRO_EXPANSION"
    TOK_QUOTATION_MARK = 584,      // "QUOTATION_MARK"
    TOK_RUN_TIME_VAR_BLD = 585,    // "RUN_TIME_VAR_BLD"
    TOK_RUN_TIME_VAR_DUR = 586,    // "RUN_TIME_VAR_DUR"
    TOK_RUN_TIME_VAR_HSV = 587,    // "RUN_TIME_VAR_HSV"
    TOK_RUN_TIME_VAR_REMOTE_USER = 588, // "RUN_TIME_VAR_REMOTE_USER"
    TOK_RUN_TIME_VAR_TIME = 589,   // "RUN_TIME_VAR_TIME"
    TOK_RUN_TIME_VAR_TIME_DAY = 590, // "RUN_TIME_VAR_TIME_DAY"
    TOK_RUN_TIME_VAR_TIME_EPOCH = 591, // "RUN_TIME_VAR_TIME_EPOCH"
    TOK_RUN_TIME_VAR_TIME_HOUR = 592, // "RUN_TIME_VAR_TIME_HOUR"
    TOK_RUN_TIME_VAR_TIME_MIN = 593, // "RUN_TIME_VAR_TIME_MIN"
    TOK_RUN_TIME_VAR_TIME_MON = 594, // "RUN_TIME_VAR_TIME_MON"
    TOK_RUN_TIME_VAR_TIME_SEC = 595, // "RUN_TIME_VAR_TIME_SEC"
    TOK_RUN_TIME_VAR_TIME_WDAY = 596, // "RUN_TIME_VAR_TIME_WDAY"
    TOK_RUN_TIME_VAR_TIME_YEAR = 597, // "RUN_TIME_VAR_TIME_YEAR"
    TOK_VARIABLE = 598,            // "VARIABLE"
    TOK_DICT_ELEMENT = 599,        // "Dictionary element"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_SETVAR_OPERATION_EQUALS_APPEND = 103,  // SETVAR_OPERATION_EQUALS_APPEND
        S_SETVAR_OPERATION_EQUALS_PREPEND = 104, // SETVAR_OPERATION_EQUALS_PREPEND
        S_NOT = 105,                             // "NOT"
        S_OPERATOR_BEGINS_WITH = 106,            // "OPERATOR_BEGINS_WITH"
        S_OPERATOR_CONTAINS = 107,               // "OPERATOR_CONTAINS"
        S_OPERATOR_CONTAINS_WORD = 108,          // "OPERATOR_CONTAINS_WORD"
        S_OPERATOR_DETECT_SQLI = 109,            // "OPERATOR_DETECT_SQLI"
        S_OPERATOR_DETECT_XSS = 110,             // "OPERATOR_DETECT_XSS"
        S_OPERATOR_ENDS_WITH = 111,              // "OPERATOR_ENDS_WITH"
        S_OPERATOR_EQ = 112,                     // "OPERATOR_EQ"
        S_OPERATOR_FUZZY_HASH = 113,             // "OPERATOR_FUZZY_HASH"
        S_OPERATOR_GEOLOOKUP = 114,              // "OPERATOR_GEOLOOKUP"
        S_OPERATOR_GE = 115,                     // "OPERATOR_GE"
        S_OPERATOR_GSB_LOOKUP = 116,             // "OPERATOR_GSB_LOOKUP"
        S_OPERATOR_GT = 117,                     // "OPERATOR_GT"
        S_OPERATOR_INSPECT_FILE = 118,           // "OPERATOR_INSPECT_FILE"
        S_OPERATOR_IP_MATCH_FROM_FILE = 119,     // "OPERATOR_IP_MATCH_FROM_FILE"
        S_OPERATOR_IP_MATCH = 120,               // "OPERATOR_IP_MATCH"
        S_OPERATOR_LE = 121,                     // "OPERATOR_LE"
        S_OPERATOR_LT = 122,                     // "OPERATOR_LT"
        S_OPERATOR_PM_FROM_FILE = 123,           // "OPERATOR_PM_FROM_FILE"
        S_OPERATOR_PM = 124,                     // "OPERATOR_PM"
        S_OPERATOR_RBL = 125,                    // "OPERATOR_RBL"
        S_OPERATOR_RSUB = 126,                   // "OPERATOR_RSUB"
        S_OPERATOR_RX_CONTENT_ONLY = 127,        // "Operator RX (content only)"
        S_OPERATOR_RX = 128,                     // "OPERATOR_RX"
        S_OPERATOR_RX_GLOBAL = 129,              // "OPERATOR_RX_GLOBAL"
        S_OPERATOR_STR_EQ = 130,                 // "OPERATOR_STR_EQ"
        S_OPERATOR_STR_MATCH = 131,              // "OPERATOR_STR_MATCH"
        S_OPERATOR_UNCONDITIONAL_MATCH = 132,    // "OPERATOR_UNCONDITIONAL_MATCH"
        S_OPERATOR_VALIDATE_BYTE_RANGE = 133,    // "OPERATOR_VALIDATE_BYTE_RANGE"
        S_OPERATOR_VALIDATE_DTD = 134,           // "OPERATOR_VALIDATE_DTD"
        S_OPERATOR_VALIDATE_HASH = 135,          // "OPERATOR_VALIDATE_HASH"
        S_OPERATOR_VALIDATE_SCHEMA = 136,        // "OPERATOR_VALIDATE_SCHEMA"
        S_OPERATOR_VALIDATE_URL_ENCODING = 137,  // "OPERATOR_VALIDATE_URL_ENCODING"
        S_OPERATOR_VALIDATE_UTF8_ENCODING = 138, // "OPERATOR_VALIDATE_UTF8_ENCODING"
        S_OPERATOR_VERIFY_CC = 139,              // "OPERATOR_VERIFY_CC"
        S_OPERATOR_VERIFY_CPF = 140,             // "OPERATOR_VERIFY_CPF"
        S_OPERATOR_VERIFY_SSN = 141,             // "OPERATOR_VERIFY_SSN"
        S_OPERATOR_VERIFY_SVNR = 142,            // "OPERATOR_VERIFY_SVNR"
        S_OPERATOR_WITHIN = 143,                 // "OPERATOR_WITHIN"
        S_CONFIG_DIR_AUDIT_LOG_FMT = 144,        // CONFIG_DIR_AUDIT_LOG_FMT
        S_JSON = 145,                            // JSON
        S_NATIVE = 146,                          // NATIVE
        S_ACTION_CTL_RULE_ENGINE = 147,          // "ACTION_CTL_RULE_ENGINE"
        S_ACTION_ACCURACY = 148,                 // "Accuracy"
        S_ACTION_ALLOW = 149,                    // "Allow"
        S_ACTION_APPEND = 150,                   // "Append"
        S_ACTION_AUDIT_LOG = 151,                // "AuditLog"
        S_ACTION_BLOCK = 152,                    // "Block"
        S_ACTION_CAPTURE = 153,                  // "Capture"
        S_ACTION_CHAIN = 154,                    // "Chain"
        S_ACTION_CTL_AUDIT_ENGINE = 155,         // "ACTION_CTL_AUDIT_ENGINE"
        S_ACTION_CTL_AUDIT_LOG_PARTS = 156,      // "ACTION_CTL_AUDIT_LOG_PARTS"
        S_ACTION_CTL_BDY_JSON = 157,             // "ACTION_CTL_BDY_JSON"
        S_ACTION_CTL_BDY_XML = 158,              // "ACTION_CTL_BDY_XML"
        S_ACTION_CTL_BDY_URLENCODED = 159,       // "ACTION_CTL_BDY_URLENCODED"
        S_ACTION_CTL_FORCE_REQ_BODY_VAR = 160,   // "ACTION_CTL_FORCE_REQ_BODY_VAR"
        S_ACTION_CTL_REQUEST_BODY_ACCESS = 161,  // "ACTION_CTL_REQUEST_BODY_ACCESS"
        S_ACTION_CTL_RULE_REMOVE_BY_ID = 162,    // "ACTION_CTL_RULE_REMOVE_BY_ID"
        S_ACTION_CTL_RULE_REMOVE_BY_TAG = 163,   // "ACTION_CTL_RULE_REMOVE_BY_TAG"
        S_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 164, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_ID"
        S_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 165, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG"
        S_ACTION_DENY = 166,                     // "Deny"
        S_ACTION_DEPRECATE_VAR = 167,            // "DeprecateVar"
        S_ACTION_DROP = 168,                     // "Drop"
        S_ACTION_EXEC = 169,                     // "Exec"
        S_ACTION_EXPIRE_VAR = 170,               // "ExpireVar"
        S_ACTION_ID = 171,                       // "Id"
        S_ACTION_INITCOL = 172,                  // "InitCol"
        S_ACTION_LOG = 173,                      // "Log"
        S_ACTION_LOG_DATA = 174,                 // "LogData"
        S_ACTION_MATURITY = 175,                 // "Maturity"
        S_ACTION_MSG = 176,                      // "Msg"
        S_ACTION_MULTI_MATCH = 177,              // "MultiMatch"
        S_ACTION_NO_AUDIT_LOG = 178,             // "NoAuditLog"
        S_ACTION_NO_LOG = 179,                   // "NoLog"
        S_ACTION_PASS = 180,                     // "Pass"
        S_ACTION_PAUSE = 181,                    // "Pause"
        S_ACTION_PHASE = 182,                    // "Phase"
        S_ACTION_PREPEND = 183,                  // "Prepend"
        S_ACTION_PROXY = 184,                    // "Proxy"
        S_ACTION_REDIRECT = 185,                 // "Redirect"
        S_ACTION_REV = 186,                      // "Rev"
        S_ACTION_SANITISE_ARG = 187,             // "SanitiseArg"
        S_ACTION_SANITISE_MATCHED = 188,         // "SanitiseMatched"
        S_ACTION_SANITISE_MATCHED_BYTES = 189,   // "SanitiseMatchedBytes"
        S_ACTION_SANITISE_REQUEST_HEADER = 190,  // "SanitiseRequestHeader"
        S_ACTION_SANITISE_RESPONSE_HEADER = 191, // "SanitiseResponseHeader"
        S_ACTION_SETENV = 192,                   // "SetEnv"
        S_ACTION_SETRSC = 193,                   // "SetRsc"
        S_ACTION_SETSID = 194,                   // "SetSid"
        S_ACTION_SETUID = 195,                   // "SetUID"
        S_ACTION_SEVERITY = 196,                 // "Severity"
        S_ACTION_SKIP = 197,                     // "Skip"
        S_ACTION_SKIP_AFTER = 198,               // "SkipAfter"
        S_ACTION_STATUS = 199,                   // "Status"
        S_ACTION_TAG = 200,                      // "Tag"
        S_ACTION_TRANSFORMATION_BASE_64_ENCODE = 201, // "ACTION_TRANSFORMATION_BASE_64_ENCODE"
        S_ACTION_TRANSFORMATION_BASE_64_DECODE = 202, // "ACTION_TRANSFORMATION_BASE_64_DECODE"
        S_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 203, // "ACTION_TRANSFORMATION_BASE_64_DECODE_EXT"
        S_ACTION_TRANSFORMATION_CMD_LINE = 204,  // "ACTION_TRANSFORMATION_CMD_LINE"
        S_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 205, // "ACTION_TRANSFORMATION_COMPRESS_WHITESPACE"
        S_ACTION_TRANSFORMATION_CSS_DECODE = 206, // "ACTION_TRANSFORMATION_CSS_DECODE"
        S_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 207, // "ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE"
        S_ACTION_TRANSFORMATION_HEX_ENCODE = 208, // "ACTION_TRANSFORMATION_HEX_ENCODE"
        S_ACTION_TRANSFORMATION_HEX_DECODE = 209, // "ACTION_TRANSFORMATION_HEX_DECODE"
        S_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 210, // "ACTION_TRANSFORMATION_HTML_ENTITY_DECODE"
        S_ACTION_TRANSFORMATION_JS_DECODE = 211, // "ACTION_TRANSFORMATION_JS_DECODE"
        S_ACTION_TRANSFORMATION_LENGTH = 212,    // "ACTION_TRANSFORMATION_LENGTH"
        S_ACTION_TRANSFORMATION_LOWERCASE = 213, // "ACTION_TRANSFORMATION_LOWERCASE"
        S_ACTION_TRANSFORMATION_PHP_ARGS_NAMES = 214, // "ACTION_TRANSFORMATION_PHP_ARGS_NAMES"
        ...
        S_CONFIG_DIR_REQ_BODY = 273,             // "CONFIG_DIR_REQ_BODY"
        S_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 274, // "CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT"
        S_CONFIG_DIR_REQ_BODY_LIMIT = 275,       // "CONFIG_DIR_REQ_BODY_LIMIT"
        S_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 276, // "CONFIG_DIR_REQ_BODY_LIMIT_ACTION"
        S_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 277, // "CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT"
        S_CONFIG_DIR_RES_BODY = 278,             // "CONFIG_DIR_RES_BODY"
        S_CONFIG_DIR_RES_BODY_LIMIT = 279,       // "CONFIG_DIR_RES_BODY_LIMIT"
        S_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 280, // "CONFIG_DIR_RES_BODY_LIMIT_ACTION"
        S_CONFIG_SEC_RULE_INHERITANCE = 281,     // "CONFIG_SEC_RULE_INHERITANCE"
        S_CONFIG_SEC_RULE_PERF_TIME = 282,       // "CONFIG_SEC_RULE_PERF_TIME"
        S_CONFIG_DIR_RULE_ENG = 283,             // "CONFIG_DIR_RULE_ENG"
        S_CONFIG_DIR_SEC_ACTION = 284,           // "CONFIG_DIR_SEC_ACTION"
        S_CONFIG_DIR_SEC_DEFAULT_ACTION = 285,   // "CONFIG_DIR_SEC_DEFAULT_ACTION"
        S_CONFIG_DIR_SEC_MARKER = 286,           // "CONFIG_DIR_SEC_MARKER"
        S_CONFIG_DIR_UNICODE_MAP_FILE = 287,     // "CONFIG_DIR_UNICODE_MAP_FILE"
        S_CONFIG_DIR_UNICODE_CODE_PAGE = 288,    // "CONFIG_DIR_UNICODE_CODE_PAGE"
        S_CONFIG_SEC_COLLECTION_TIMEOUT = 289,   // "CONFIG_SEC_COLLECTION_TIMEOUT"
        S_CONFIG_SEC_HTTP_BLKEY = 290,           // "CONFIG_SEC_HTTP_BLKEY"
        S_CONFIG_SEC_INTERCEPT_ON_ERROR = 291,   // "CONFIG_SEC_INTERCEPT_ON_ERROR"
        S_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 292, // "CONFIG_SEC_REMOTE_RULES_FAIL_ACTION"
        S_CONFIG_SEC_RULE_REMOVE_BY_ID = 293,    // "CONFIG_SEC_RULE_REMOVE_BY_ID"
        S_CONFIG_SEC_RULE_REMOVE_BY_MSG = 294,   // "CONFIG_SEC_RULE_REMOVE_BY_MSG"
        S_CONFIG_SEC_RULE_REMOVE_BY_TAG = 295,   // "CONFIG_SEC_RULE_REMOVE_BY_TAG"
        S_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 296, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG"
        S_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 297, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG"
        S_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 298, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID"
        S_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 299, // "CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID"
        S_CONFIG_UPDLOAD_KEEP_FILES = 300,       // "CONFIG_UPDLOAD_KEEP_FILES"
        S_CONFIG_UPDLOAD_SAVE_TMP_FILES = 301,   // "CONFIG_UPDLOAD_SAVE_TMP_FILES"
        S_CONFIG_UPLOAD_DIR = 302,               // "CONFIG_UPLOAD_DIR"
        S_CONFIG_UPLOAD_FILE_LIMIT = 303,        // "CONFIG_UPLOAD_FILE_LIMIT"
        S_CONFIG_UPLOAD_FILE_MODE = 304,         // "CONFIG_UPLOAD_FILE_MODE"
        S_CONFIG_VALUE_ABORT = 305,              // "CONFIG_VALUE_ABORT"
        S_CONFIG_VALUE_DETC = 306,               // "CONFIG_VALUE_DETC"
        S_CONFIG_VALUE_HTTPS = 307,              // "CONFIG_VALUE_HTTPS"
        S_CONFIG_VALUE_OFF = 308,                // "CONFIG_VALUE_OFF"
        S_CONFIG_VALUE_ON = 309,                 // "CONFIG_VALUE_ON"
        S_CONFIG_VALUE_PARALLEL = 310,           // "CONFIG_VALUE_PARALLEL"
        S_CONFIG_VALUE_PROCESS_PARTIAL = 311,    // "CONFIG_VALUE_PROCESS_PARTIAL"
        S_CONFIG_VALUE_REJECT = 312,             // "CONFIG_VALUE_REJECT"
        S_CONFIG_VALUE_RELEVANT_ONLY = 313,      // "CONFIG_VALUE_RELEVANT_ONLY"
        S_CONFIG_VALUE_SERIAL = 314,             // "CONFIG_VALUE_SERIAL"
        S_CONFIG_VALUE_WARN = 315,               // "CONFIG_VALUE_WARN"
        S_CONFIG_XML_EXTERNAL_ENTITY = 316,      // "CONFIG_XML_EXTERNAL_ENTITY"
        S_CONGIG_DIR_RESPONSE_BODY_MP = 317,     // "CONGIG_DIR_RESPONSE_BODY_MP"
        S_CONGIG_DIR_SEC_ARG_SEP = 318,          // "CONGIG_DIR_SEC_ARG_SEP"
        S_CONGIG_DIR_SEC_COOKIE_FORMAT = 319,    // "CONGIG_DIR_SEC_COOKIE_FORMAT"
        S_CONFIG_SEC_COOKIEV0_SEPARATOR = 320,   // "CONFIG_SEC_COOKIEV0_SEPARATOR"
        S_CONGIG_DIR_SEC_DATA_DIR = 321,         // "CONGIG_DIR_SEC_DATA_DIR"
        S_CONGIG_DIR_SEC_STATUS_ENGINE = 322,    // "CONGIG_DIR_SEC_STATUS_ENGINE"
        S_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 323, // "CONFIG_SEC_STREAM_IN_BODY_INSPECTION"
        S_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 324, // "CONFIG_SEC_STREAM_OUT_BODY_INSPECTION"
        S_CONGIG_DIR_SEC_TMP_DIR = 325,          // "CONGIG_DIR_SEC_TMP_DIR"
        S_DIRECTIVE = 326,                       // "DIRECTIVE"
        S_DIRECTIVE_SECRULESCRIPT = 327,         // "DIRECTIVE_SECRULESCRIPT"
        S_FREE_TEXT_QUOTE_MACRO_EXPANSION = 328, // "FREE_TEXT_QUOTE_MACRO_EXPANSION"
        S_QUOTATION_MARK = 329,                  // "QUOTATION_MARK"
        S_RUN_TIME_VAR_BLD = 330,                // "RUN_TIME_VAR_BLD"
        S_RUN_TIME_VAR_DUR = 331,                // "RUN_TIME_VAR_DUR"
        S_RUN_TIME_VAR_HSV = 332,                // "RUN_TIME_VAR_HSV"
        S_RUN_TIME_VAR_REMOTE_USER = 333,        // "RUN_TIME_VAR_REMOTE_USER"
        S_RUN_TIME_VAR_TIME = 334,               // "RUN_TIME_VAR_TIME"
        S_RUN_TIME_VAR_TIME_DAY = 335,           // "RUN_TIME_VAR_TIME_DAY"
        S_RUN_TIME_VAR_TIME_EPOCH = 336,         // "RUN_TIME_VAR_TIME_EPOCH"
        S_RUN_TIME_VAR_TIME_HOUR = 337,          // "RUN_TIME_VAR_TIME_HOUR"
        S_RUN_TIME_VAR_TIME_MIN = 338,           // "RUN_TIME_VAR_TIME_MIN"
        S_RUN_TIME_VAR_TIME_MON = 339,           // "RUN_TIME_VAR_TIME_MON"
        S_RUN_TIME_VAR_TIME_SEC = 340,           // "RUN_TIME_VAR_TIME_SEC"
        S_RUN_TIME_VAR_TIME_WDAY = 341,          // "RUN_TIME_VAR_TIME_WDAY"
        S_RUN_TIME_VAR_TIME_YEAR = 342,          // "RUN_TIME_VAR_TIME_YEAR"
        S_VARIABLE = 343,                        // "VARIABLE"
        S_DICT_ELEMENT = 344,                    // "Dictionary element"
...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_SETVAR_OPERATION_EQUALS_APPEND (location_type l)
      {
        return symbol_type (token::TOK_SETVAR_OPERATION_EQUALS_APPEND, std::move (l));
      }
#else
      static
      symbol_type
      make_SETVAR_OPERATION_EQUALS_APPEND (const location_type& l)
      {
        return symbol_type (token::TOK_SETVAR_OPERATION_EQUALS_APPEND, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_SETVAR_OPERATION_EQUALS_PREPEND (location_type l)
      {
        return symbol_type (token::TOK_SETVAR_OPERATION_EQUALS_PREPEND, std::move (l));
      }
#else
      static
      symbol_type
      make_SETVAR_OPERATION_EQUALS_PREPEND (const location_type& l)
      {
        return symbol_type (token::TOK_SETVAR_OPERATION_EQUALS_PREPEND, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ACTION_TRANSFORMATION_PHP_ARGS_NAMES (std::string v, location_type l)
      {
        return symbol_type (token::TOK_ACTION_TRANSFORMATION_PHP_ARGS_NAMES, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ACTION_TRANSFORMATION_PHP_ARGS_NAMES (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_ACTION_TRANSFORMATION_PHP_ARGS_NAMES, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
