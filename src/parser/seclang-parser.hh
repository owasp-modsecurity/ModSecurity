...
#line 448 "seclang-parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_NEW_LINE = 260,
        TOK_VAR_COUNT = 261,
        TOK_VAR_EXCLUSION = 262,
        TOK_VARIABLE_ARGS = 263,
        TOK_VARIABLE_ARGS_POST = 264,
        TOK_VARIABLE_ARGS_GET = 265,
        TOK_VARIABLE_FILES_SIZES = 266,
        TOK_VARIABLE_FILES_NAMES = 267,
        TOK_VARIABLE_FILES_TMP_CONTENT = 268,
        TOK_VARIABLE_MULTIPART_FILENAME = 269,
        TOK_VARIABLE_MULTIPART_NAME = 270,
        TOK_VARIABLE_MATCHED_VARS_NAMES = 271,
        TOK_VARIABLE_MATCHED_VARS = 272,
        TOK_VARIABLE_FILES = 273,
        TOK_VARIABLE_REQUEST_COOKIES = 274,
        TOK_VARIABLE_REQUEST_HEADERS = 275,
        TOK_VARIABLE_RESPONSE_HEADERS = 276,
        TOK_VARIABLE_GEO = 277,
        TOK_VARIABLE_REQUEST_COOKIES_NAMES = 278,
        TOK_VARIABLE_ARGS_COMBINED_SIZE = 279,
        TOK_VARIABLE_ARGS_GET_NAMES = 280,
        TOK_VARIABLE_RULE = 281,
        TOK_VARIABLE_ARGS_NAMES = 282,
        TOK_VARIABLE_ARGS_POST_NAMES = 283,
        TOK_VARIABLE_AUTH_TYPE = 284,
        TOK_VARIABLE_FILES_COMBINED_SIZE = 285,
        TOK_VARIABLE_FILES_TMP_NAMES = 286,
        TOK_VARIABLE_FULL_REQUEST = 287,
        TOK_VARIABLE_FULL_REQUEST_LENGTH = 288,
        TOK_VARIABLE_INBOUND_DATA_ERROR = 289,
        TOK_VARIABLE_MATCHED_VAR = 290,
        TOK_VARIABLE_MATCHED_VAR_NAME = 291,
        TOK_VARIABLE_MULTIPART_CRLF_LF_LINES = 292,
        TOK_VARIABLE_MULTIPART_DATA_AFTER = 293,
        TOK_VARIABLE_MULTIPART_FILE_LIMIT_EXCEEDED = 294,
        TOK_VARIABLE_MULTIPART_HEADER_FOLDING = 295,
        TOK_VARIABLE_MULTIPART_INVALID_HEADER_FOLDING = 296,
        TOK_VARIABLE_MULTIPART_INVALID_QUOTING = 297,
        TOK_VARIABLE_MULTIPART_STRICT_ERROR = 298,
        TOK_VARIABLE_MULTIPART_UNMATCHED_BOUNDARY = 299,
        TOK_VARIABLE_OUTBOUND_DATA_ERROR = 300,
        TOK_VARIABLE_PATH_INFO = 301,
        TOK_VARIABLE_QUERY_STRING = 302,
        TOK_VARIABLE_REMOTE_ADDR = 303,
        TOK_VARIABLE_REMOTE_HOST = 304,
        TOK_VARIABLE_REMOTE_PORT = 305,
        TOK_VARIABLE_REQBODY_ERROR_MSG = 306,
        TOK_VARIABLE_REQBODY_ERROR = 307,
        TOK_VARIABLE_REQBODY_PROCESSOR_ERROR_MSG = 308,
        TOK_VARIABLE_REQBODY_PROCESSOR_ERROR = 309,
        TOK_VARIABLE_REQBODY_PROCESSOR = 310,
        TOK_VARIABLE_REQUEST_BASENAME = 311,
        TOK_VARIABLE_REQUEST_BODY_LENGTH = 312,
        TOK_VARIABLE_REQUEST_BODY = 313,
        TOK_VARIABLE_REQUEST_FILE_NAME = 314,
        TOK_VARIABLE_REQUEST_HEADERS_NAMES = 315,
        TOK_VARIABLE_REQUEST_LINE = 316,
        TOK_VARIABLE_REQUEST_METHOD = 317,
        TOK_VARIABLE_REQUEST_PROTOCOL = 318,
        TOK_VARIABLE_REQUEST_URI_RAW = 319,
        TOK_VARIABLE_REQUEST_URI = 320,
        TOK_VARIABLE_RESOURCE = 321,
        TOK_VARIABLE_RESPONSE_BODY = 322,
        TOK_VARIABLE_RESPONSE_CONTENT_LENGTH = 323,
        TOK_VARIABLE_RESPONSE_CONTENT_TYPE = 324,
        TOK_VARIABLE_RESPONSE_HEADERS_NAMES = 325,
        TOK_VARIABLE_RESPONSE_PROTOCOL = 326,
        TOK_VARIABLE_RESPONSE_STATUS = 327,
        TOK_VARIABLE_SERVER_ADDR = 328,
        TOK_VARIABLE_SERVER_NAME = 329,
        TOK_VARIABLE_SERVER_PORT = 330,
        TOK_VARIABLE_SESSION_ID = 331,
        TOK_VARIABLE_UNIQUE_ID = 332,
        TOK_VARIABLE_URL_ENCODED_ERROR = 333,
        TOK_VARIABLE_USER_ID = 334,
        TOK_VARIABLE_STATUS = 335,
        TOK_VARIABLE_IP = 336,
        TOK_VARIABLE_GLOBAL = 337,
        TOK_VARIABLE_TX = 338,
        TOK_VARIABLE_SESSION = 339,
        TOK_VARIABLE_USER = 340,
        TOK_RUN_TIME_VAR_ENV = 341,
        TOK_RUN_TIME_VAR_XML = 342,
        TOK_ACTION_SETVAR = 343,
        TOK_SETVAR_OPERATION_EQUALS = 344,
        ...
        TOK_ACTION_DENY = 365,
        TOK_ACTION_DEPRECATE_VAR = 366,
        TOK_ACTION_DROP = 367,
        TOK_ACTION_EXEC = 368,
        TOK_ACTION_EXPIRE_VAR = 369,
        TOK_ACTION_ID = 370,
        TOK_ACTION_INITCOL = 371,
        TOK_ACTION_LOG = 372,
        TOK_ACTION_LOG_DATA = 373,
        TOK_ACTION_MATURITY = 374,
        TOK_ACTION_MSG = 375,
        TOK_ACTION_MULTI_MATCH = 376,
        TOK_ACTION_NO_AUDIT_LOG = 377,
        TOK_ACTION_NO_LOG = 378,
        TOK_ACTION_PASS = 379,
        TOK_ACTION_PAUSE = 380,
        TOK_ACTION_PHASE = 381,
        TOK_ACTION_PREPEND = 382,
        TOK_ACTION_PROXY = 383,
        TOK_ACTION_REDIRECT = 384,
        TOK_ACTION_REV = 385,
        TOK_ACTION_SANATISE_ARG = 386,
        TOK_ACTION_SANATISE_MATCHED = 387,
        TOK_ACTION_SANATISE_MATCHED_BYTES = 388,
        TOK_ACTION_SANATISE_REQUEST_HEADER = 389,
        TOK_ACTION_SANATISE_RESPONSE_HEADER = 390,
        TOK_ACTION_SETENV = 391,
        TOK_ACTION_SETRSC = 392,
        TOK_ACTION_SETSID = 393,
        TOK_ACTION_SETUID = 394,
        TOK_ACTION_SEVERITY = 395,
        TOK_ACTION_SKIP = 396,
        TOK_ACTION_SKIP_AFTER = 397,
        TOK_ACTION_STATUS = 398,
        TOK_ACTION_TAG = 399,
        TOK_ACTION_TRANSFORMATION_CMD_LINE = 400,
        TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 401,
        TOK_ACTION_TRANSFORMATION_CSS_DECODE = 402,
        TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 403,
        TOK_ACTION_TRANSFORMATION_HEX_DECODE = 404,
        TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 405,
        TOK_ACTION_TRANSFORMATION_JS_DECODE = 406,
        TOK_ACTION_TRANSFORMATION_LENGTH = 407,
        TOK_ACTION_TRANSFORMATION_LOWERCASE = 408,
        TOK_ACTION_TRANSFORMATION_MD5 = 409,
        TOK_ACTION_TRANSFORMATION_NONE = 410,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH = 411,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 412,
        TOK_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 413,
        TOK_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 414,
        TOK_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 415,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 416,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 417,
        TOK_ACTION_TRANSFORMATION_REMOVE_NULLS = 418,
        TOK_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 419,
        TOK_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 420,
        TOK_ACTION_TRANSFORMATION_REPLACE_NULLS = 421,
        TOK_ACTION_TRANSFORMATION_SHA1 = 422,
        TOK_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 423,
        TOK_ACTION_TRANSFORMATION_TRIM = 424,
        TOK_ACTION_TRANSFORMATION_UPPERCASE = 425,
        TOK_ACTION_TRANSFORMATION_URL_DECODE = 426,
        TOK_ACTION_TRANSFORMATION_URL_DECODE_UNI = 427,
        TOK_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 428,
        TOK_ACTION_VER = 429,
        TOK_ACTION_XMLNS = 430,
        TOK_CONFIG_COMPONENT_SIG = 431,
        TOK_CONFIG_DIR_AUDIT_DIR = 432,
        TOK_CONFIG_DIR_AUDIT_DIR_MOD = 433,
        TOK_CONFIG_DIR_AUDIT_ENG = 434,
        TOK_CONFIG_DIR_AUDIT_FLE_MOD = 435,
        TOK_CONFIG_DIR_AUDIT_LOG = 436,
        TOK_CONFIG_DIR_AUDIT_LOG2 = 437,
        TOK_CONFIG_DIR_AUDIT_LOG_P = 438,
        TOK_CONFIG_DIR_AUDIT_STS = 439,
        TOK_CONFIG_DIR_AUDIT_TPE = 440,
        TOK_CONFIG_DIR_DEBUG_LOG = 441,
        TOK_CONFIG_DIR_DEBUG_LVL = 442,
        TOK_CONFIG_DIR_GEO_DB = 443,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 444,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 445,
        TOK_CONFIG_DIR_REQ_BODY = 446,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 447,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 448,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 449,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 450,
        TOK_CONFIG_DIR_RES_BODY = 451,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 452,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 453,
        TOK_CONFIG_DIR_RULE_ENG = 454,
        TOK_CONFIG_DIR_SEC_ACTION = 455,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 456,
        TOK_CONFIG_DIR_SEC_MARKER = 457,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 458,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 459,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 460,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 461,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 462,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 463,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 464,
        TOK_CONFIG_UPLOAD_DIR = 465,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 466,
        TOK_CONFIG_UPLOAD_FILE_MODE = 467,
        TOK_CONFIG_VALUE_ABORT = 468,
        TOK_CONFIG_VALUE_DETC = 469,
        TOK_CONFIG_VALUE_HTTPS = 470,
        TOK_CONFIG_VALUE_OFF = 471,
        TOK_CONFIG_VALUE_ON = 472,
        TOK_CONFIG_VALUE_PARALLEL = 473,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 474,
        TOK_CONFIG_VALUE_REJECT = 475,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 476,
        TOK_CONFIG_VALUE_SERIAL = 477,
        TOK_CONFIG_VALUE_WARN = 478,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 479,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 480,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 481,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 482,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 483,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 484,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 485,
        TOK_DIRECTIVE = 486,
        TOK_DIRECTIVE_SECRULESCRIPT = 487,
        TOK_FREE_TEXT = 488,
        TOK_OPERATOR = 489,
        TOK_OPERATOR_BEGINS_WITH = 490,
        TOK_OPERATOR_CONTAINS = 491,
        TOK_OPERATOR_CONTAINS_WORD = 492,
        TOK_OPERATOR_DETECT_SQLI = 493,
        TOK_OPERATOR_DETECT_XSS = 494,
        TOK_OPERATOR_ENDS_WITH = 495,
        TOK_OPERATOR_EQ = 496,
        TOK_OPERATOR_FUZZY_HASH = 497,
        TOK_OPERATOR_GE = 498,
        TOK_OPERATOR_GEOLOOKUP = 499,
        TOK_OPERATOR_GSB_LOOKUP = 500,
        TOK_OPERATOR_GT = 501,
        TOK_OPERATOR_INSPECT_FILE = 502,
        TOK_OPERATOR_IP_MATCH = 503,
        TOK_OPERATOR_IP_MATCH_FROM_FILE = 504,
        TOK_OPERATOR_LE = 505,
        TOK_OPERATOR_LT = 506,
        TOK_OPERATOR_PM = 507,
        TOK_OPERATOR_PM_FROM_FILE = 508,
        TOK_OPERATOR_RBL = 509,
        TOK_OPERATOR_RSUB = 510,
        TOK_OPERATOR_RX = 511,
        TOK_OPERATOR_RX_CONTENT_ONLY = 512,
        TOK_OPERATOR_STR_EQ = 513,
        TOK_OPERATOR_STR_MATCH = 514,
        TOK_OPERATOR_UNCONDITIONAL_MATCH = 515,
        TOK_OPERATOR_VALIDATE_BYTE_RANGE = 516,
        TOK_OPERATOR_VALIDATE_DTD = 517,
        TOK_OPERATOR_VALIDATE_HASH = 518,
        TOK_OPERATOR_VALIDATE_SCHEMA = 519,
        TOK_OPERATOR_VALIDATE_URL_ENCODING = 520,
        TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 521,
        TOK_OPERATOR_VERIFY_CC = 522,
        TOK_OPERATOR_VERIFY_CPF = 523,
        TOK_OPERATOR_VERIFY_SSN = 524,
        TOK_OPERATOR_WITHIN = 525,
        TOK_OP_QUOTE = 526,
        TOK_QUOTATION_MARK = 527,
        TOK_RUN_TIME_VAR_BLD = 528,
        TOK_RUN_TIME_VAR_DUR = 529,
        TOK_RUN_TIME_VAR_HSV = 530,
        TOK_RUN_TIME_VAR_REMOTE_USER = 531,
        TOK_RUN_TIME_VAR_TIME = 532,
        TOK_RUN_TIME_VAR_TIME_DAY = 533,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 534,
        TOK_RUN_TIME_VAR_TIME_HOUR = 535,
        TOK_RUN_TIME_VAR_TIME_MIN = 536,
        TOK_RUN_TIME_VAR_TIME_MON = 537,
        TOK_RUN_TIME_VAR_TIME_SEC = 538,
        TOK_RUN_TIME_VAR_TIME_WDAY = 539,
        TOK_RUN_TIME_VAR_TIME_YEAR = 540,
        TOK_VARIABLE = 541,
        TOK_DICT_ELEMENT = 542,
        TOK_DICT_ELEMENT_REGEXP = 543
      };
    };
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 1010,     ///< Last index in yytable_.
      yynnts_ = 13,  ///< Number of nonterminal symbols.
      yyfinal_ = 266, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
      yyntokens_ = 289  ///< Number of tokens.
    };
  ...
  seclang_parser::yytranslate_ (token_type t)
  {
    ...
    const unsigned int user_token_number_max_ = 543;
...
#line 5543 "seclang-parser.hh" // lalr1.cc:377
