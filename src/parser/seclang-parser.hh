...
#line 449 "seclang-parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_NEW_LINE = 261,
        TOK_VAR_COUNT = 262,
        TOK_VAR_EXCLUSION = 263,
        TOK_VARIABLE_ARGS = 264,
        TOK_VARIABLE_ARGS_POST = 265,
        TOK_VARIABLE_ARGS_GET = 266,
        TOK_VARIABLE_FILES_SIZES = 267,
        TOK_VARIABLE_FILES_NAMES = 268,
        TOK_VARIABLE_FILES_TMP_CONTENT = 269,
        TOK_VARIABLE_MULTIPART_FILENAME = 270,
        TOK_VARIABLE_MULTIPART_NAME = 271,
        TOK_VARIABLE_MATCHED_VARS_NAMES = 272,
        TOK_VARIABLE_MATCHED_VARS = 273,
        TOK_VARIABLE_FILES = 274,
        TOK_VARIABLE_REQUEST_COOKIES = 275,
        TOK_VARIABLE_REQUEST_HEADERS = 276,
        TOK_VARIABLE_RESPONSE_HEADERS = 277,
        TOK_VARIABLE_GEO = 278,
        TOK_VARIABLE_REQUEST_COOKIES_NAMES = 279,
        TOK_VARIABLE_ARGS_COMBINED_SIZE = 280,
        TOK_VARIABLE_ARGS_GET_NAMES = 281,
        TOK_VARIABLE_RULE = 282,
        TOK_VARIABLE_ARGS_NAMES = 283,
        TOK_VARIABLE_ARGS_POST_NAMES = 284,
        TOK_VARIABLE_AUTH_TYPE = 285,
        TOK_VARIABLE_FILES_COMBINED_SIZE = 286,
        TOK_VARIABLE_FILES_TMP_NAMES = 287,
        TOK_VARIABLE_FULL_REQUEST = 288,
        TOK_VARIABLE_FULL_REQUEST_LENGTH = 289,
        TOK_VARIABLE_INBOUND_DATA_ERROR = 290,
        TOK_VARIABLE_MATCHED_VAR = 291,
        TOK_VARIABLE_MATCHED_VAR_NAME = 292,
        TOK_VARIABLE_MULTIPART_CRLF_LF_LINES = 293,
        TOK_VARIABLE_MULTIPART_DATA_AFTER = 294,
        TOK_VARIABLE_MULTIPART_FILE_LIMIT_EXCEEDED = 295,
        TOK_VARIABLE_MULTIPART_HEADER_FOLDING = 296,
        TOK_VARIABLE_MULTIPART_INVALID_HEADER_FOLDING = 297,
        TOK_VARIABLE_MULTIPART_INVALID_QUOTING = 298,
        TOK_VARIABLE_MULTIPART_STRICT_ERROR = 299,
        TOK_VARIABLE_MULTIPART_UNMATCHED_BOUNDARY = 300,
        TOK_VARIABLE_OUTBOUND_DATA_ERROR = 301,
        TOK_VARIABLE_PATH_INFO = 302,
        TOK_VARIABLE_QUERY_STRING = 303,
        TOK_VARIABLE_REMOTE_ADDR = 304,
        TOK_VARIABLE_REMOTE_HOST = 305,
        TOK_VARIABLE_REMOTE_PORT = 306,
        TOK_VARIABLE_REQBODY_ERROR_MSG = 307,
        TOK_VARIABLE_REQBODY_ERROR = 308,
        TOK_VARIABLE_REQBODY_PROCESSOR_ERROR_MSG = 309,
        TOK_VARIABLE_REQBODY_PROCESSOR_ERROR = 310,
        TOK_VARIABLE_REQBODY_PROCESSOR = 311,
        TOK_VARIABLE_REQUEST_BASENAME = 312,
        TOK_VARIABLE_REQUEST_BODY_LENGTH = 313,
        TOK_VARIABLE_REQUEST_BODY = 314,
        TOK_VARIABLE_REQUEST_FILE_NAME = 315,
        TOK_VARIABLE_REQUEST_HEADERS_NAMES = 316,
        TOK_VARIABLE_REQUEST_LINE = 317,
        TOK_VARIABLE_REQUEST_METHOD = 318,
        TOK_VARIABLE_REQUEST_PROTOCOL = 319,
        TOK_VARIABLE_REQUEST_URI_RAW = 320,
        TOK_VARIABLE_REQUEST_URI = 321,
        TOK_VARIABLE_RESOURCE = 322,
        TOK_VARIABLE_RESPONSE_BODY = 323,
        TOK_VARIABLE_RESPONSE_CONTENT_LENGTH = 324,
        TOK_VARIABLE_RESPONSE_CONTENT_TYPE = 325,
        TOK_VARIABLE_RESPONSE_HEADERS_NAMES = 326,
        TOK_VARIABLE_RESPONSE_PROTOCOL = 327,
        TOK_VARIABLE_RESPONSE_STATUS = 328,
        TOK_VARIABLE_SERVER_ADDR = 329,
        TOK_VARIABLE_SERVER_NAME = 330,
        TOK_VARIABLE_SERVER_PORT = 331,
        TOK_VARIABLE_SESSION_ID = 332,
        TOK_VARIABLE_UNIQUE_ID = 333,
        TOK_VARIABLE_URL_ENCODED_ERROR = 334,
        TOK_VARIABLE_USER_ID = 335,
        TOK_VARIABLE_STATUS = 336,
        TOK_VARIABLE_IP = 337,
        TOK_VARIABLE_GLOBAL = 338,
        TOK_VARIABLE_TX = 339,
        TOK_VARIABLE_SESSION = 340,
        TOK_VARIABLE_USER = 341,
        TOK_RUN_TIME_VAR_ENV = 342,
        TOK_RUN_TIME_VAR_XML = 343,
        TOK_ACTION_SETVAR = 344,
        TOK_SETVAR_OPERATION_EQUALS = 345,
        TOK_SETVAR_OPERATION_EQUALS_PLUS = 346,
        TOK_SETVAR_OPERATION_EQUALS_MINUS = 347,
        TOK_NOT = 348,
        TOK_ACTION_CTL_RULE_ENGINE = 349,
        TOK_ACTION_ACCURACY = 350,
        TOK_ACTION_ALLOW = 351,
        TOK_ACTION_APPEND = 352,
        TOK_ACTION_AUDIT_LOG = 353,
        TOK_ACTION_BLOCK = 354,
        TOK_ACTION_CAPTURE = 355,
        TOK_ACTION_CHAIN = 356,
        TOK_ACTION_CTL_AUDIT_ENGINE = 357,
        TOK_ACTION_CTL_AUDIT_LOG_PARTS = 358,
        TOK_ACTION_CTL_BDY_JSON = 359,
        TOK_ACTION_CTL_BDY_XML = 360,
        TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 361,
        TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 362,
        TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 363,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 364,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 365,
        TOK_ACTION_DENY = 366,
        TOK_ACTION_DEPRECATE_VAR = 367,
        TOK_ACTION_DROP = 368,
        TOK_ACTION_EXEC = 369,
        TOK_ACTION_EXPIRE_VAR = 370,
        TOK_ACTION_ID = 371,
        TOK_ACTION_INITCOL = 372,
        TOK_ACTION_LOG = 373,
        TOK_ACTION_LOG_DATA = 374,
        TOK_ACTION_MATURITY = 375,
        TOK_ACTION_MSG = 376,
        TOK_ACTION_MULTI_MATCH = 377,
        TOK_ACTION_NO_AUDIT_LOG = 378,
        TOK_ACTION_NO_LOG = 379,
        TOK_ACTION_PASS = 380,
        TOK_ACTION_PAUSE = 381,
        TOK_ACTION_PHASE = 382,
        TOK_ACTION_PREPEND = 383,
        TOK_ACTION_PROXY = 384,
        TOK_ACTION_REDIRECT = 385,
        TOK_ACTION_REV = 386,
        TOK_ACTION_SANATISE_ARG = 387,
        TOK_ACTION_SANATISE_MATCHED = 388,
        TOK_ACTION_SANATISE_MATCHED_BYTES = 389,
        TOK_ACTION_SANATISE_REQUEST_HEADER = 390,
        TOK_ACTION_SANATISE_RESPONSE_HEADER = 391,
        TOK_ACTION_SETENV = 392,
        TOK_ACTION_SETRSC = 393,
        TOK_ACTION_SETSID = 394,
        TOK_ACTION_SETUID = 395,
        TOK_ACTION_SEVERITY = 396,
        TOK_ACTION_SKIP = 397,
        TOK_ACTION_SKIP_AFTER = 398,
        TOK_ACTION_STATUS = 399,
        TOK_ACTION_TAG = 400,
        TOK_ACTION_TRANSFORMATION_CMD_LINE = 401,
        TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 402,
        TOK_ACTION_TRANSFORMATION_CSS_DECODE = 403,
        TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 404,
        TOK_ACTION_TRANSFORMATION_HEX_DECODE = 405,
        TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 406,
        TOK_ACTION_TRANSFORMATION_JS_DECODE = 407,
        TOK_ACTION_TRANSFORMATION_LENGTH = 408,
        TOK_ACTION_TRANSFORMATION_LOWERCASE = 409,
        TOK_ACTION_TRANSFORMATION_MD5 = 410,
        TOK_ACTION_TRANSFORMATION_NONE = 411,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH = 412,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 413,
        TOK_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 414,
        TOK_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 415,
        TOK_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 416,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 417,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 418,
        TOK_ACTION_TRANSFORMATION_REMOVE_NULLS = 419,
        TOK_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 420,
        TOK_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 421,
        TOK_ACTION_TRANSFORMATION_REPLACE_NULLS = 422,
        TOK_ACTION_TRANSFORMATION_SHA1 = 423,
        TOK_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 424,
        TOK_ACTION_TRANSFORMATION_TRIM = 425,
        TOK_ACTION_TRANSFORMATION_UPPERCASE = 426,
        TOK_ACTION_TRANSFORMATION_URL_DECODE = 427,
        TOK_ACTION_TRANSFORMATION_URL_DECODE_UNI = 428,
        TOK_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 429,
        TOK_ACTION_VER = 430,
        TOK_ACTION_XMLNS = 431,
        TOK_CONFIG_COMPONENT_SIG = 432,
        TOK_CONFIG_SEC_ARGUMENT_SEPARATOR = 433,
        TOK_CONFIG_SEC_WEB_APP_ID = 434,
        TOK_CONFIG_SEC_SERVER_SIG = 435,
        TOK_CONFIG_DIR_AUDIT_DIR = 436,
        TOK_CONFIG_DIR_AUDIT_DIR_MOD = 437,
        TOK_CONFIG_DIR_AUDIT_ENG = 438,
        TOK_CONFIG_DIR_AUDIT_FLE_MOD = 439,
        TOK_CONFIG_DIR_AUDIT_LOG = 440,
        TOK_CONFIG_DIR_AUDIT_LOG2 = 441,
        TOK_CONFIG_DIR_AUDIT_LOG_P = 442,
        TOK_CONFIG_DIR_AUDIT_STS = 443,
        TOK_CONFIG_DIR_AUDIT_TPE = 444,
        TOK_CONFIG_DIR_DEBUG_LOG = 445,
        TOK_CONFIG_DIR_DEBUG_LVL = 446,
        TOK_CONFIG_SEC_CACHE_TRANSFORMATIONS = 447,
        TOK_CONFIG_DIR_GEO_DB = 448,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 449,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 450,
        TOK_CONFIG_DIR_REQ_BODY = 451,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 452,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 453,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 454,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 455,
        TOK_CONFIG_DIR_RES_BODY = 456,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 457,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 458,
        TOK_CONFIG_DIR_RULE_ENG = 459,
        TOK_CONFIG_DIR_SEC_ACTION = 460,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 461,
        TOK_CONFIG_DIR_SEC_MARKER = 462,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 463,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 464,
        TOK_CONFIG_SEC_HTTP_BLKEY = 465,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 466,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 467,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 468,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 469,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 470,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 471,
        TOK_CONFIG_UPLOAD_DIR = 472,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 473,
        TOK_CONFIG_UPLOAD_FILE_MODE = 474,
        TOK_CONFIG_VALUE_ABORT = 475,
        TOK_CONFIG_VALUE_DETC = 476,
        TOK_CONFIG_VALUE_HTTPS = 477,
        TOK_CONFIG_VALUE_OFF = 478,
        TOK_CONFIG_VALUE_ON = 479,
        TOK_CONFIG_VALUE_PARALLEL = 480,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 481,
        TOK_CONFIG_VALUE_REJECT = 482,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 483,
        TOK_CONFIG_VALUE_SERIAL = 484,
        TOK_CONFIG_VALUE_WARN = 485,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 486,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 487,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 488,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 489,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 490,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 491,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 492,
        TOK_DIRECTIVE = 493,
        TOK_DIRECTIVE_SECRULESCRIPT = 494,
        TOK_FREE_TEXT = 495,
        TOK_OPERATOR = 496,
        TOK_OPERATOR_BEGINS_WITH = 497,
        TOK_OPERATOR_CONTAINS = 498,
        TOK_OPERATOR_CONTAINS_WORD = 499,
        TOK_OPERATOR_DETECT_SQLI = 500,
        TOK_OPERATOR_DETECT_XSS = 501,
        TOK_OPERATOR_ENDS_WITH = 502,
        TOK_OPERATOR_EQ = 503,
        TOK_OPERATOR_FUZZY_HASH = 504,
        TOK_OPERATOR_GE = 505,
        TOK_OPERATOR_GEOLOOKUP = 506,
        TOK_OPERATOR_GSB_LOOKUP = 507,
        TOK_OPERATOR_GT = 508,
        TOK_OPERATOR_INSPECT_FILE = 509,
        TOK_OPERATOR_IP_MATCH = 510,
        TOK_OPERATOR_IP_MATCH_FROM_FILE = 511,
        TOK_OPERATOR_LE = 512,
        TOK_OPERATOR_LT = 513,
        TOK_OPERATOR_PM = 514,
        TOK_OPERATOR_PM_FROM_FILE = 515,
        TOK_OPERATOR_RBL = 516,
        TOK_OPERATOR_RSUB = 517,
        TOK_OPERATOR_RX = 518,
        TOK_OPERATOR_RX_CONTENT_ONLY = 519,
        TOK_OPERATOR_STR_EQ = 520,
        TOK_OPERATOR_STR_MATCH = 521,
        TOK_OPERATOR_UNCONDITIONAL_MATCH = 522,
        TOK_OPERATOR_VALIDATE_BYTE_RANGE = 523,
        TOK_OPERATOR_VALIDATE_DTD = 524,
        TOK_OPERATOR_VALIDATE_HASH = 525,
        TOK_OPERATOR_VALIDATE_SCHEMA = 526,
        TOK_OPERATOR_VALIDATE_URL_ENCODING = 527,
        TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 528,
        TOK_OPERATOR_VERIFY_CC = 529,
        TOK_OPERATOR_VERIFY_CPF = 530,
        TOK_OPERATOR_VERIFY_SSN = 531,
        TOK_OPERATOR_WITHIN = 532,
        TOK_OP_QUOTE = 533,
        TOK_QUOTATION_MARK = 534,
        TOK_RUN_TIME_VAR_BLD = 535,
        TOK_RUN_TIME_VAR_DUR = 536,
        TOK_RUN_TIME_VAR_HSV = 537,
        TOK_RUN_TIME_VAR_REMOTE_USER = 538,
        TOK_RUN_TIME_VAR_TIME = 539,
        TOK_RUN_TIME_VAR_TIME_DAY = 540,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 541,
        TOK_RUN_TIME_VAR_TIME_HOUR = 542,
        TOK_RUN_TIME_VAR_TIME_MIN = 543,
        TOK_RUN_TIME_VAR_TIME_MON = 544,
        TOK_RUN_TIME_VAR_TIME_SEC = 545,
        TOK_RUN_TIME_VAR_TIME_WDAY = 546,
        TOK_RUN_TIME_VAR_TIME_YEAR = 547,
        TOK_VARIABLE = 548,
        TOK_DICT_ELEMENT = 549,
        TOK_DICT_ELEMENT_REGEXP = 550
      };
    };
  ...
  private:
    ...
    enum
    {
      ...
      yyfinal_ = 276, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
...
#line 5648 "seclang-parser.hh" // lalr1.cc:377
