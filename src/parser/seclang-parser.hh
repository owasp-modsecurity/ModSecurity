  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_CONFIG_SEC_WEB_APP_ID = 433,
        TOK_CONFIG_SEC_SERVER_SIG = 434,
        TOK_CONFIG_DIR_AUDIT_DIR = 435,
        TOK_CONFIG_DIR_AUDIT_DIR_MOD = 436,
        TOK_CONFIG_DIR_AUDIT_ENG = 437,
        TOK_CONFIG_DIR_AUDIT_FLE_MOD = 438,
        TOK_CONFIG_DIR_AUDIT_LOG = 439,
        TOK_CONFIG_DIR_AUDIT_LOG2 = 440,
        TOK_CONFIG_DIR_AUDIT_LOG_P = 441,
        TOK_CONFIG_DIR_AUDIT_STS = 442,
        TOK_CONFIG_DIR_AUDIT_TPE = 443,
        TOK_CONFIG_DIR_DEBUG_LOG = 444,
        TOK_CONFIG_DIR_DEBUG_LVL = 445,
        TOK_CONFIG_DIR_GEO_DB = 446,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 447,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 448,
        TOK_CONFIG_DIR_REQ_BODY = 449,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 450,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 451,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 452,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 453,
        TOK_CONFIG_DIR_RES_BODY = 454,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 455,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 456,
        TOK_CONFIG_DIR_RULE_ENG = 457,
        TOK_CONFIG_DIR_SEC_ACTION = 458,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 459,
        TOK_CONFIG_DIR_SEC_MARKER = 460,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 461,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 462,
        TOK_CONFIG_SEC_HTTP_BLKEY = 463,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 464,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 465,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 466,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 467,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 468,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 469,
        TOK_CONFIG_UPLOAD_DIR = 470,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 471,
        TOK_CONFIG_UPLOAD_FILE_MODE = 472,
        TOK_CONFIG_VALUE_ABORT = 473,
        TOK_CONFIG_VALUE_DETC = 474,
        TOK_CONFIG_VALUE_HTTPS = 475,
        TOK_CONFIG_VALUE_OFF = 476,
        TOK_CONFIG_VALUE_ON = 477,
        TOK_CONFIG_VALUE_PARALLEL = 478,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 479,
        TOK_CONFIG_VALUE_REJECT = 480,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 481,
        TOK_CONFIG_VALUE_SERIAL = 482,
        TOK_CONFIG_VALUE_WARN = 483,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 484,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 485,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 486,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 487,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 488,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 489,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 490,
        TOK_DIRECTIVE = 491,
        TOK_DIRECTIVE_SECRULESCRIPT = 492,
        TOK_FREE_TEXT = 493,
        TOK_OPERATOR = 494,
        TOK_OPERATOR_BEGINS_WITH = 495,
        TOK_OPERATOR_CONTAINS = 496,
        TOK_OPERATOR_CONTAINS_WORD = 497,
        TOK_OPERATOR_DETECT_SQLI = 498,
        TOK_OPERATOR_DETECT_XSS = 499,
        TOK_OPERATOR_ENDS_WITH = 500,
        TOK_OPERATOR_EQ = 501,
        TOK_OPERATOR_FUZZY_HASH = 502,
        TOK_OPERATOR_GE = 503,
        TOK_OPERATOR_GEOLOOKUP = 504,
        TOK_OPERATOR_GSB_LOOKUP = 505,
        TOK_OPERATOR_GT = 506,
        TOK_OPERATOR_INSPECT_FILE = 507,
        TOK_OPERATOR_IP_MATCH = 508,
        TOK_OPERATOR_IP_MATCH_FROM_FILE = 509,
        TOK_OPERATOR_LE = 510,
        TOK_OPERATOR_LT = 511,
        TOK_OPERATOR_PM = 512,
        TOK_OPERATOR_PM_FROM_FILE = 513,
        TOK_OPERATOR_RBL = 514,
        TOK_OPERATOR_RSUB = 515,
        TOK_OPERATOR_RX = 516,
        TOK_OPERATOR_RX_CONTENT_ONLY = 517,
        TOK_OPERATOR_STR_EQ = 518,
        TOK_OPERATOR_STR_MATCH = 519,
        TOK_OPERATOR_UNCONDITIONAL_MATCH = 520,
        TOK_OPERATOR_VALIDATE_BYTE_RANGE = 521,
        TOK_OPERATOR_VALIDATE_DTD = 522,
        TOK_OPERATOR_VALIDATE_HASH = 523,
        TOK_OPERATOR_VALIDATE_SCHEMA = 524,
        TOK_OPERATOR_VALIDATE_URL_ENCODING = 525,
        TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 526,
        TOK_OPERATOR_VERIFY_CC = 527,
        TOK_OPERATOR_VERIFY_CPF = 528,
        TOK_OPERATOR_VERIFY_SSN = 529,
        TOK_OPERATOR_WITHIN = 530,
        TOK_OP_QUOTE = 531,
        TOK_QUOTATION_MARK = 532,
        TOK_RUN_TIME_VAR_BLD = 533,
        TOK_RUN_TIME_VAR_DUR = 534,
        TOK_RUN_TIME_VAR_HSV = 535,
        TOK_RUN_TIME_VAR_REMOTE_USER = 536,
        TOK_RUN_TIME_VAR_TIME = 537,
        TOK_RUN_TIME_VAR_TIME_DAY = 538,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 539,
        TOK_RUN_TIME_VAR_TIME_HOUR = 540,
        TOK_RUN_TIME_VAR_TIME_MIN = 541,
        TOK_RUN_TIME_VAR_TIME_MON = 542,
        TOK_RUN_TIME_VAR_TIME_SEC = 543,
        TOK_RUN_TIME_VAR_TIME_WDAY = 544,
        TOK_RUN_TIME_VAR_TIME_YEAR = 545,
        TOK_VARIABLE = 546,
        TOK_DICT_ELEMENT = 547,
        TOK_DICT_ELEMENT_REGEXP = 548
      };
    };
...
#line 5615 "seclang-parser.hh" // lalr1.cc:377
