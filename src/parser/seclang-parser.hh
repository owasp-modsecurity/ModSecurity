  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 410,
        TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 411,
        TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 412,
        TOK_ACTION_CTL_RULE_REMOVE_BY_TAG = 413,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 414,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 415,
        TOK_ACTION_DENY = 416,
        TOK_ACTION_DEPRECATE_VAR = 417,
        TOK_ACTION_DROP = 418,
        TOK_ACTION_EXEC = 419,
        TOK_ACTION_EXPIRE_VAR = 420,
        TOK_ACTION_ID = 421,
        TOK_ACTION_INITCOL = 422,
        TOK_ACTION_LOG = 423,
        TOK_ACTION_LOG_DATA = 424,
        TOK_ACTION_MATURITY = 425,
        TOK_ACTION_MSG = 426,
        TOK_ACTION_MULTI_MATCH = 427,
        TOK_ACTION_NO_AUDIT_LOG = 428,
        TOK_ACTION_NO_LOG = 429,
        TOK_ACTION_PASS = 430,
        TOK_ACTION_PAUSE = 431,
        TOK_ACTION_PHASE = 432,
        TOK_ACTION_PREPEND = 433,
        TOK_ACTION_PROXY = 434,
        TOK_ACTION_REDIRECT = 435,
        TOK_ACTION_REV = 436,
        TOK_ACTION_SANATISE_ARG = 437,
        TOK_ACTION_SANATISE_MATCHED = 438,
        TOK_ACTION_SANATISE_MATCHED_BYTES = 439,
        TOK_ACTION_SANATISE_REQUEST_HEADER = 440,
        TOK_ACTION_SANATISE_RESPONSE_HEADER = 441,
        TOK_ACTION_SETENV = 442,
        TOK_ACTION_SETRSC = 443,
        TOK_ACTION_SETSID = 444,
        TOK_ACTION_SETUID = 445,
        TOK_ACTION_SEVERITY = 446,
        TOK_ACTION_SKIP = 447,
        TOK_ACTION_SKIP_AFTER = 448,
        TOK_ACTION_STATUS = 449,
        TOK_ACTION_TAG = 450,
        TOK_ACTION_TRANSFORMATION_BASE_64_ENCODE = 451,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE = 452,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 453,
        TOK_ACTION_TRANSFORMATION_CMD_LINE = 454,
        TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 455,
        TOK_ACTION_TRANSFORMATION_CSS_DECODE = 456,
        TOK_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 457,
        TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 458,
        TOK_ACTION_TRANSFORMATION_HEX_DECODE = 459,
        TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 460,
        TOK_ACTION_TRANSFORMATION_JS_DECODE = 461,
        TOK_ACTION_TRANSFORMATION_LENGTH = 462,
        TOK_ACTION_TRANSFORMATION_LOWERCASE = 463,
        TOK_ACTION_TRANSFORMATION_MD5 = 464,
        TOK_ACTION_TRANSFORMATION_NONE = 465,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH = 466,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 467,
        TOK_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 468,
        TOK_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 469,
        TOK_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 470,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 471,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 472,
        TOK_ACTION_TRANSFORMATION_REMOVE_NULLS = 473,
        TOK_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 474,
        TOK_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 475,
        TOK_ACTION_TRANSFORMATION_REPLACE_NULLS = 476,
        TOK_ACTION_TRANSFORMATION_SHA1 = 477,
        TOK_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 478,
        TOK_ACTION_TRANSFORMATION_TRIM = 479,
        TOK_ACTION_TRANSFORMATION_TRIM_LEFT = 480,
        TOK_ACTION_TRANSFORMATION_TRIM_RIGHT = 481,
        TOK_ACTION_TRANSFORMATION_UPPERCASE = 482,
        TOK_ACTION_TRANSFORMATION_URL_ENCODE = 483,
        TOK_ACTION_TRANSFORMATION_URL_DECODE = 484,
        TOK_ACTION_TRANSFORMATION_URL_DECODE_UNI = 485,
        TOK_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 486,
        TOK_ACTION_VER = 487,
        TOK_ACTION_XMLNS = 488,
        TOK_CONFIG_COMPONENT_SIG = 489,
        TOK_CONFIG_CONN_ENGINE = 490,
        TOK_CONFIG_SEC_ARGUMENT_SEPARATOR = 491,
        TOK_CONFIG_SEC_WEB_APP_ID = 492,
        TOK_CONFIG_SEC_SERVER_SIG = 493,
        TOK_CONFIG_DIR_AUDIT_DIR = 494,
        TOK_CONFIG_DIR_AUDIT_DIR_MOD = 495,
        TOK_CONFIG_DIR_AUDIT_ENG = 496,
        TOK_CONFIG_DIR_AUDIT_FLE_MOD = 497,
        TOK_CONFIG_DIR_AUDIT_LOG = 498,
        TOK_CONFIG_DIR_AUDIT_LOG2 = 499,
        TOK_CONFIG_DIR_AUDIT_LOG_P = 500,
        TOK_CONFIG_DIR_AUDIT_STS = 501,
        TOK_CONFIG_DIR_AUDIT_TPE = 502,
        TOK_CONFIG_DIR_DEBUG_LOG = 503,
        TOK_CONFIG_DIR_DEBUG_LVL = 504,
        TOK_CONFIG_SEC_CACHE_TRANSFORMATIONS = 505,
        TOK_CONFIG_SEC_DISABLE_BACKEND_COMPRESS = 506,
        TOK_CONFIG_SEC_HASH_ENGINE = 507,
        TOK_CONFIG_SEC_HASH_KEY = 508,
        TOK_CONFIG_SEC_HASH_PARAM = 509,
        TOK_CONFIG_SEC_HASH_METHOD_RX = 510,
        TOK_CONFIG_SEC_HASH_METHOD_PM = 511,
        TOK_CONFIG_SEC_CHROOT_DIR = 512,
        TOK_CONFIG_DIR_GEO_DB = 513,
        TOK_CONFIG_DIR_GSB_DB = 514,
        TOK_CONFIG_SEC_GUARDIAN_LOG = 515,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 516,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 517,
        TOK_CONFIG_SEC_CONN_R_STATE_LIMIT = 518,
        TOK_CONFIG_SEC_CONN_W_STATE_LIMIT = 519,
        TOK_CONFIG_SEC_SENSOR_ID = 520,
        TOK_CONFIG_DIR_REQ_BODY = 521,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 522,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 523,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 524,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 525,
        TOK_CONFIG_DIR_RES_BODY = 526,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 527,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 528,
        TOK_CONFIG_SEC_RULE_INHERITANCE = 529,
        TOK_CONFIG_SEC_RULE_PERF_TIME = 530,
        TOK_CONFIG_DIR_RULE_ENG = 531,
        TOK_CONFIG_DIR_SEC_ACTION = 532,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 533,
        TOK_CONFIG_DIR_SEC_MARKER = 534,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 535,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 536,
        TOK_CONFIG_SEC_HTTP_BLKEY = 537,
        TOK_CONFIG_SEC_INTERCEPT_ON_ERROR = 538,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 539,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 540,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 541,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 542,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 543,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 544,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 545,
        TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 546,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 547,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 548,
        TOK_CONFIG_UPLOAD_DIR = 549,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 550,
        TOK_CONFIG_UPLOAD_FILE_MODE = 551,
        TOK_CONFIG_VALUE_ABORT = 552,
        TOK_CONFIG_VALUE_DETC = 553,
        TOK_CONFIG_VALUE_HTTPS = 554,
        TOK_CONFIG_VALUE_OFF = 555,
        TOK_CONFIG_VALUE_ON = 556,
        TOK_CONFIG_VALUE_PARALLEL = 557,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 558,
        TOK_CONFIG_VALUE_REJECT = 559,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 560,
        TOK_CONFIG_VALUE_SERIAL = 561,
        TOK_CONFIG_VALUE_WARN = 562,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 563,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 564,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 565,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 566,
        TOK_CONFIG_SEC_COOKIEV0_SEPARATOR = 567,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 568,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 569,
        TOK_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 570,
        TOK_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 571,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 572,
        TOK_DIRECTIVE = 573,
        TOK_DIRECTIVE_SECRULESCRIPT = 574,
        TOK_FREE_TEXT_QUOTE_MACRO_EXPANSION = 575,
        TOK_QUOTATION_MARK = 576,
        TOK_RUN_TIME_VAR_BLD = 577,
        TOK_RUN_TIME_VAR_DUR = 578,
        TOK_RUN_TIME_VAR_HSV = 579,
        TOK_RUN_TIME_VAR_REMOTE_USER = 580,
        TOK_RUN_TIME_VAR_TIME = 581,
        TOK_RUN_TIME_VAR_TIME_DAY = 582,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 583,
        TOK_RUN_TIME_VAR_TIME_HOUR = 584,
        TOK_RUN_TIME_VAR_TIME_MIN = 585,
        TOK_RUN_TIME_VAR_TIME_MON = 586,
        TOK_RUN_TIME_VAR_TIME_SEC = 587,
        TOK_RUN_TIME_VAR_TIME_WDAY = 588,
        TOK_RUN_TIME_VAR_TIME_YEAR = 589,
        TOK_VARIABLE = 590,
        TOK_DICT_ELEMENT = 591,
        TOK_DICT_ELEMENT_REGEXP = 592
      };
    };
