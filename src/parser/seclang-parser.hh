  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_OPERATOR_RX = 381,
        TOK_OPERATOR_RX_GLOBAL = 382,
        TOK_OPERATOR_STR_EQ = 383,
        TOK_OPERATOR_STR_MATCH = 384,
        TOK_OPERATOR_UNCONDITIONAL_MATCH = 385,
        TOK_OPERATOR_VALIDATE_BYTE_RANGE = 386,
        TOK_OPERATOR_VALIDATE_DTD = 387,
        TOK_OPERATOR_VALIDATE_HASH = 388,
        TOK_OPERATOR_VALIDATE_SCHEMA = 389,
        TOK_OPERATOR_VALIDATE_URL_ENCODING = 390,
        TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 391,
        TOK_OPERATOR_VERIFY_CC = 392,
        TOK_OPERATOR_VERIFY_CPF = 393,
        TOK_OPERATOR_VERIFY_SSN = 394,
        TOK_OPERATOR_VERIFY_SVNR = 395,
        TOK_OPERATOR_WITHIN = 396,
        TOK_CONFIG_DIR_AUDIT_LOG_FMT = 397,
        TOK_JSON = 398,
        TOK_NATIVE = 399,
        TOK_ACTION_CTL_RULE_ENGINE = 400,
        TOK_ACTION_ACCURACY = 401,
        TOK_ACTION_ALLOW = 402,
        TOK_ACTION_APPEND = 403,
        TOK_ACTION_AUDIT_LOG = 404,
        TOK_ACTION_BLOCK = 405,
        TOK_ACTION_CAPTURE = 406,
        TOK_ACTION_CHAIN = 407,
        TOK_ACTION_CTL_AUDIT_ENGINE = 408,
        TOK_ACTION_CTL_AUDIT_LOG_PARTS = 409,
        TOK_ACTION_CTL_BDY_JSON = 410,
        TOK_ACTION_CTL_BDY_XML = 411,
        TOK_ACTION_CTL_BDY_URLENCODED = 412,
        TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 413,
        TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 414,
        TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 415,
        TOK_ACTION_CTL_RULE_REMOVE_BY_TAG = 416,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 417,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 418,
        TOK_ACTION_DENY = 419,
        TOK_ACTION_DEPRECATE_VAR = 420,
        TOK_ACTION_DROP = 421,
        TOK_ACTION_EXEC = 422,
        TOK_ACTION_EXPIRE_VAR = 423,
        TOK_ACTION_ID = 424,
        TOK_ACTION_INITCOL = 425,
        TOK_ACTION_LOG = 426,
        TOK_ACTION_LOG_DATA = 427,
        TOK_ACTION_MATURITY = 428,
        TOK_ACTION_MSG = 429,
        TOK_ACTION_MULTI_MATCH = 430,
        TOK_ACTION_NO_AUDIT_LOG = 431,
        TOK_ACTION_NO_LOG = 432,
        TOK_ACTION_PASS = 433,
        TOK_ACTION_PAUSE = 434,
        TOK_ACTION_PHASE = 435,
        TOK_ACTION_PREPEND = 436,
        TOK_ACTION_PROXY = 437,
        TOK_ACTION_REDIRECT = 438,
        TOK_ACTION_REV = 439,
        TOK_ACTION_SANITISE_ARG = 440,
        TOK_ACTION_SANITISE_MATCHED = 441,
        TOK_ACTION_SANITISE_MATCHED_BYTES = 442,
        TOK_ACTION_SANITISE_REQUEST_HEADER = 443,
        TOK_ACTION_SANITISE_RESPONSE_HEADER = 444,
        TOK_ACTION_SETENV = 445,
        TOK_ACTION_SETRSC = 446,
        TOK_ACTION_SETSID = 447,
        TOK_ACTION_SETUID = 448,
        TOK_ACTION_SEVERITY = 449,
        TOK_ACTION_SKIP = 450,
        TOK_ACTION_SKIP_AFTER = 451,
        TOK_ACTION_STATUS = 452,
        TOK_ACTION_TAG = 453,
        TOK_ACTION_TRANSFORMATION_BASE_64_ENCODE = 454,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE = 455,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 456,
        TOK_ACTION_TRANSFORMATION_CMD_LINE = 457,
        TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 458,
        TOK_ACTION_TRANSFORMATION_CSS_DECODE = 459,
        TOK_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 460,
        TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 461,
        TOK_ACTION_TRANSFORMATION_HEX_DECODE = 462,
        TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 463,
        TOK_ACTION_TRANSFORMATION_JS_DECODE = 464,
        TOK_ACTION_TRANSFORMATION_LENGTH = 465,
        TOK_ACTION_TRANSFORMATION_LOWERCASE = 466,
        TOK_ACTION_TRANSFORMATION_PHP_ARGS_NAMES = 467,
        TOK_ACTION_TRANSFORMATION_MD5 = 468,
        TOK_ACTION_TRANSFORMATION_NONE = 469,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH = 470,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 471,
        TOK_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 472,
        TOK_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 473,
        TOK_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 474,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 475,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 476,
        TOK_ACTION_TRANSFORMATION_REMOVE_NULLS = 477,
        TOK_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 478,
        TOK_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 479,
        TOK_ACTION_TRANSFORMATION_REPLACE_NULLS = 480,
        TOK_ACTION_TRANSFORMATION_SHA1 = 481,
        TOK_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 482,
        TOK_ACTION_TRANSFORMATION_TRIM = 483,
        TOK_ACTION_TRANSFORMATION_TRIM_LEFT = 484,
        TOK_ACTION_TRANSFORMATION_TRIM_RIGHT = 485,
        TOK_ACTION_TRANSFORMATION_UPPERCASE = 486,
        TOK_ACTION_TRANSFORMATION_URL_ENCODE = 487,
        TOK_ACTION_TRANSFORMATION_URL_DECODE = 488,
        TOK_ACTION_TRANSFORMATION_URL_DECODE_UNI = 489,
        TOK_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 490,
        TOK_ACTION_VER = 491,
        TOK_ACTION_XMLNS = 492,
        TOK_CONFIG_COMPONENT_SIG = 493,
        TOK_CONFIG_CONN_ENGINE = 494,
        TOK_CONFIG_SEC_ARGUMENT_SEPARATOR = 495,
        TOK_CONFIG_SEC_WEB_APP_ID = 496,
        TOK_CONFIG_SEC_SERVER_SIG = 497,
        TOK_CONFIG_DIR_AUDIT_DIR = 498,
        TOK_CONFIG_DIR_AUDIT_DIR_MOD = 499,
        TOK_CONFIG_DIR_AUDIT_ENG = 500,
        TOK_CONFIG_DIR_AUDIT_FLE_MOD = 501,
        TOK_CONFIG_DIR_AUDIT_LOG = 502,
        TOK_CONFIG_DIR_AUDIT_LOG2 = 503,
        TOK_CONFIG_DIR_AUDIT_LOG_P = 504,
        TOK_CONFIG_DIR_AUDIT_STS = 505,
        TOK_CONFIG_DIR_AUDIT_TPE = 506,
        TOK_CONFIG_DIR_DEBUG_LOG = 507,
        TOK_CONFIG_DIR_DEBUG_LVL = 508,
        TOK_CONFIG_SEC_CACHE_TRANSFORMATIONS = 509,
        TOK_CONFIG_SEC_DISABLE_BACKEND_COMPRESS = 510,
        TOK_CONFIG_SEC_HASH_ENGINE = 511,
        TOK_CONFIG_SEC_HASH_KEY = 512,
        TOK_CONFIG_SEC_HASH_PARAM = 513,
        TOK_CONFIG_SEC_HASH_METHOD_RX = 514,
        TOK_CONFIG_SEC_HASH_METHOD_PM = 515,
        TOK_CONFIG_SEC_CHROOT_DIR = 516,
        TOK_CONFIG_DIR_GEO_DB = 517,
        TOK_CONFIG_DIR_GSB_DB = 518,
        TOK_CONFIG_SEC_GUARDIAN_LOG = 519,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 520,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 521,
        TOK_CONFIG_SEC_CONN_R_STATE_LIMIT = 522,
        TOK_CONFIG_SEC_CONN_W_STATE_LIMIT = 523,
        TOK_CONFIG_SEC_SENSOR_ID = 524,
        TOK_CONFIG_DIR_ARGS_LIMIT = 525,
        TOK_CONFIG_DIR_REQ_BODY = 526,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 527,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 528,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 529,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 530,
        TOK_CONFIG_DIR_RES_BODY = 531,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 532,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 533,
        TOK_CONFIG_SEC_RULE_INHERITANCE = 534,
        TOK_CONFIG_SEC_RULE_PERF_TIME = 535,
        TOK_CONFIG_DIR_RULE_ENG = 536,
        TOK_CONFIG_DIR_SEC_ACTION = 537,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 538,
        TOK_CONFIG_DIR_SEC_MARKER = 539,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 540,
        TOK_CONFIG_DIR_UNICODE_CODE_PAGE = 541,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 542,
        TOK_CONFIG_SEC_HTTP_BLKEY = 543,
        TOK_CONFIG_SEC_INTERCEPT_ON_ERROR = 544,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 545,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 546,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 547,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 548,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 549,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 550,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 551,
        TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 552,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 553,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 554,
        TOK_CONFIG_UPLOAD_DIR = 555,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 556,
        TOK_CONFIG_UPLOAD_FILE_MODE = 557,
        TOK_CONFIG_VALUE_ABORT = 558,
        TOK_CONFIG_VALUE_DETC = 559,
        TOK_CONFIG_VALUE_HTTPS = 560,
        TOK_CONFIG_VALUE_OFF = 561,
        TOK_CONFIG_VALUE_ON = 562,
        TOK_CONFIG_VALUE_PARALLEL = 563,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 564,
        TOK_CONFIG_VALUE_REJECT = 565,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 566,
        TOK_CONFIG_VALUE_SERIAL = 567,
        TOK_CONFIG_VALUE_WARN = 568,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 569,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 570,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 571,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 572,
        TOK_CONFIG_SEC_COOKIEV0_SEPARATOR = 573,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 574,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 575,
        TOK_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 576,
        TOK_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 577,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 578,
        TOK_DIRECTIVE = 579,
        TOK_DIRECTIVE_SECRULESCRIPT = 580,
        TOK_FREE_TEXT_QUOTE_MACRO_EXPANSION = 581,
        TOK_QUOTATION_MARK = 582,
        TOK_RUN_TIME_VAR_BLD = 583,
        TOK_RUN_TIME_VAR_DUR = 584,
        TOK_RUN_TIME_VAR_HSV = 585,
        TOK_RUN_TIME_VAR_REMOTE_USER = 586,
        TOK_RUN_TIME_VAR_TIME = 587,
        TOK_RUN_TIME_VAR_TIME_DAY = 588,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 589,
        TOK_RUN_TIME_VAR_TIME_HOUR = 590,
        TOK_RUN_TIME_VAR_TIME_MIN = 591,
        TOK_RUN_TIME_VAR_TIME_MON = 592,
        TOK_RUN_TIME_VAR_TIME_SEC = 593,
        TOK_RUN_TIME_VAR_TIME_WDAY = 594,
        TOK_RUN_TIME_VAR_TIME_YEAR = 595,
        TOK_VARIABLE = 596,
        TOK_DICT_ELEMENT = 597,
        TOK_DICT_ELEMENT_REGEXP = 598
      };
    };
...
switch (yytype)
    {
      ...
      case 151: // "Capture"
      case 152: // "Chain"
      case 153: // "ACTION_CTL_AUDIT_ENGINE"
      case 154: // "ACTION_CTL_AUDIT_LOG_PARTS"
      case 155: // "ACTION_CTL_BDY_JSON"
      case 156: // "ACTION_CTL_BDY_XML"
      case 157: // "ACTION_CTL_BDY_URLENCODED"
      case 158: // "ACTION_CTL_FORCE_REQ_BODY_VAR"
      case 159: // "ACTION_CTL_REQUEST_BODY_ACCESS"
      case 160: // "ACTION_CTL_RULE_REMOVE_BY_ID"
      case 161: // "ACTION_CTL_RULE_REMOVE_BY_TAG"
      case 162: // "ACTION_CTL_RULE_REMOVE_TARGET_BY_ID"
      case 163: // "ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG"
      case 164: // "Deny"
      case 165: // "DeprecateVar"
      case 166: // "Drop"
      case 167: // "Exec"
      case 168: // "ExpireVar"
      case 169: // "Id"
      ...
      case 183: // "Redirect"
      case 184: // "Rev"
      case 185: // "SanitiseArg"
      case 186: // "SanitiseMatched"
      case 187: // "SanitiseMatchedBytes"
      case 188: // "SanitiseRequestHeader"
      ...
      case 197: // "Status"
      case 198: // "Tag"
      case 199: // "ACTION_TRANSFORMATION_BASE_64_ENCODE"
      case 200: // "ACTION_TRANSFORMATION_BASE_64_DECODE"
      case 201: // "ACTION_TRANSFORMATION_BASE_64_DECODE_EXT"
      case 202: // "ACTION_TRANSFORMATION_CMD_LINE"
      case 203: // "ACTION_TRANSFORMATION_COMPRESS_WHITESPACE"
      case 204: // "ACTION_TRANSFORMATION_CSS_DECODE"
      case 205: // "ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE"
      case 206: // "ACTION_TRANSFORMATION_HEX_ENCODE"
      case 207: // "ACTION_TRANSFORMATION_HEX_DECODE"
      case 208: // "ACTION_TRANSFORMATION_HTML_ENTITY_DECODE"
      case 209: // "ACTION_TRANSFORMATION_JS_DECODE"
      case 210: // "ACTION_TRANSFORMATION_LENGTH"
      case 211: // "ACTION_TRANSFORMATION_LOWERCASE"
      case 212: // "ACTION_TRANSFORMATION_PHP_ARGS_NAMES"
      ...
      case 271: // "CONFIG_DIR_REQ_BODY"
      case 272: // "CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT"
      case 273: // "CONFIG_DIR_REQ_BODY_LIMIT"
      case 274: // "CONFIG_DIR_REQ_BODY_LIMIT_ACTION"
      case 275: // "CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT"
      case 276: // "CONFIG_DIR_RES_BODY"
      case 277: // "CONFIG_DIR_RES_BODY_LIMIT"
      case 278: // "CONFIG_DIR_RES_BODY_LIMIT_ACTION"
      case 279: // "CONFIG_SEC_RULE_INHERITANCE"
      case 280: // "CONFIG_SEC_RULE_PERF_TIME"
      case 281: // "CONFIG_DIR_RULE_ENG"
      case 282: // "CONFIG_DIR_SEC_ACTION"
      case 283: // "CONFIG_DIR_SEC_DEFAULT_ACTION"
      case 284: // "CONFIG_DIR_SEC_MARKER"
      case 285: // "CONFIG_DIR_UNICODE_MAP_FILE"
      case 286: // "CONFIG_DIR_UNICODE_CODE_PAGE"
      case 287: // "CONFIG_SEC_COLLECTION_TIMEOUT"
      case 288: // "CONFIG_SEC_HTTP_BLKEY"
      case 289: // "CONFIG_SEC_INTERCEPT_ON_ERROR"
      case 290: // "CONFIG_SEC_REMOTE_RULES_FAIL_ACTION"
      case 291: // "CONFIG_SEC_RULE_REMOVE_BY_ID"
      case 292: // "CONFIG_SEC_RULE_REMOVE_BY_MSG"
      case 293: // "CONFIG_SEC_RULE_REMOVE_BY_TAG"
      case 294: // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG"
      case 295: // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG"
      case 296: // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID"
      case 297: // "CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID"
      case 298: // "CONFIG_UPDLOAD_KEEP_FILES"
      case 299: // "CONFIG_UPDLOAD_SAVE_TMP_FILES"
      case 300: // "CONFIG_UPLOAD_DIR"
      case 301: // "CONFIG_UPLOAD_FILE_LIMIT"
      case 302: // "CONFIG_UPLOAD_FILE_MODE"
      case 303: // "CONFIG_VALUE_ABORT"
      case 304: // "CONFIG_VALUE_DETC"
      case 305: // "CONFIG_VALUE_HTTPS"
      case 306: // "CONFIG_VALUE_OFF"
      case 307: // "CONFIG_VALUE_ON"
      case 308: // "CONFIG_VALUE_PARALLEL"
      case 309: // "CONFIG_VALUE_PROCESS_PARTIAL"
      case 310: // "CONFIG_VALUE_REJECT"
      case 311: // "CONFIG_VALUE_RELEVANT_ONLY"
      case 312: // "CONFIG_VALUE_SERIAL"
      case 313: // "CONFIG_VALUE_WARN"
      case 314: // "CONFIG_XML_EXTERNAL_ENTITY"
      case 315: // "CONGIG_DIR_RESPONSE_BODY_MP"
      case 316: // "CONGIG_DIR_SEC_ARG_SEP"
      case 317: // "CONGIG_DIR_SEC_COOKIE_FORMAT"
      case 318: // "CONFIG_SEC_COOKIEV0_SEPARATOR"
      case 319: // "CONGIG_DIR_SEC_DATA_DIR"
      case 320: // "CONGIG_DIR_SEC_STATUS_ENGINE"
      case 321: // "CONFIG_SEC_STREAM_IN_BODY_INSPECTION"
      case 322: // "CONFIG_SEC_STREAM_OUT_BODY_INSPECTION"
      case 323: // "CONGIG_DIR_SEC_TMP_DIR"
      case 324: // "DIRECTIVE"
      case 325: // "DIRECTIVE_SECRULESCRIPT"
      case 326: // "FREE_TEXT_QUOTE_MACRO_EXPANSION"
      case 327: // "QUOTATION_MARK"
      case 328: // "RUN_TIME_VAR_BLD"
      case 329: // "RUN_TIME_VAR_DUR"
      case 330: // "RUN_TIME_VAR_HSV"
      case 331: // "RUN_TIME_VAR_REMOTE_USER"
      case 332: // "RUN_TIME_VAR_TIME"
      case 333: // "RUN_TIME_VAR_TIME_DAY"
      case 334: // "RUN_TIME_VAR_TIME_EPOCH"
      case 335: // "RUN_TIME_VAR_TIME_HOUR"
      case 336: // "RUN_TIME_VAR_TIME_MIN"
      case 337: // "RUN_TIME_VAR_TIME_MON"
      case 338: // "RUN_TIME_VAR_TIME_SEC"
      case 339: // "RUN_TIME_VAR_TIME_WDAY"
      case 340: // "RUN_TIME_VAR_TIME_YEAR"
      case 341: // "VARIABLE"
      case 342: // "Dictionary element"
      case 343: // "Dictionary element, selected by regexp"
        value.template destroy< std::string > ();
        break;

      case 350: // op
      case 351: // op_before_init
        value.template destroy< std::unique_ptr<Operator> > ();
        break;

      case 359: // run_time_string
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 3276,     ///< Last index in yytable_.
      yynnts_ = 16,  ///< Number of nonterminal symbols.
      yyfinal_ = 338, ///< Termination state number.
      yyntokens_ = 344  ///< Number of tokens.
    };
  ...
  seclang_parser::yytranslate_ (int t)
  {
    ...
    const int user_token_number_max_ = 598;
