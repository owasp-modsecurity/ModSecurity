  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_CONFIG_DIR_ARGS_LIMIT = 523,
        TOK_CONFIG_DIR_REQ_BODY = 524,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 525,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 526,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 527,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 528,
        TOK_CONFIG_DIR_RES_BODY = 529,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 530,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 531,
        TOK_CONFIG_SEC_RULE_INHERITANCE = 532,
        TOK_CONFIG_SEC_RULE_PERF_TIME = 533,
        TOK_CONFIG_DIR_RULE_ENG = 534,
        TOK_CONFIG_DIR_SEC_ACTION = 535,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 536,
        TOK_CONFIG_DIR_SEC_MARKER = 537,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 538,
        TOK_CONFIG_DIR_UNICODE_CODE_PAGE = 539,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 540,
        TOK_CONFIG_SEC_HTTP_BLKEY = 541,
        TOK_CONFIG_SEC_INTERCEPT_ON_ERROR = 542,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 543,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 544,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 545,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 546,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 547,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 548,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 549,
        TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 550,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 551,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 552,
        TOK_CONFIG_UPLOAD_DIR = 553,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 554,
        TOK_CONFIG_UPLOAD_FILE_MODE = 555,
        TOK_CONFIG_VALUE_ABORT = 556,
        TOK_CONFIG_VALUE_DETC = 557,
        TOK_CONFIG_VALUE_HTTPS = 558,
        TOK_CONFIG_VALUE_OFF = 559,
        TOK_CONFIG_VALUE_ON = 560,
        TOK_CONFIG_VALUE_PARALLEL = 561,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 562,
        TOK_CONFIG_VALUE_REJECT = 563,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 564,
        TOK_CONFIG_VALUE_SERIAL = 565,
        TOK_CONFIG_VALUE_WARN = 566,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 567,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 568,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 569,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 570,
        TOK_CONFIG_SEC_COOKIEV0_SEPARATOR = 571,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 572,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 573,
        TOK_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 574,
        TOK_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 575,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 576,
        TOK_DIRECTIVE = 577,
        TOK_DIRECTIVE_SECRULESCRIPT = 578,
        TOK_FREE_TEXT_QUOTE_MACRO_EXPANSION = 579,
        TOK_QUOTATION_MARK = 580,
        TOK_RUN_TIME_VAR_BLD = 581,
        TOK_RUN_TIME_VAR_DUR = 582,
        TOK_RUN_TIME_VAR_HSV = 583,
        TOK_RUN_TIME_VAR_REMOTE_USER = 584,
        TOK_RUN_TIME_VAR_TIME = 585,
        TOK_RUN_TIME_VAR_TIME_DAY = 586,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 587,
        TOK_RUN_TIME_VAR_TIME_HOUR = 588,
        TOK_RUN_TIME_VAR_TIME_MIN = 589,
        TOK_RUN_TIME_VAR_TIME_MON = 590,
        TOK_RUN_TIME_VAR_TIME_SEC = 591,
        TOK_RUN_TIME_VAR_TIME_WDAY = 592,
        TOK_RUN_TIME_VAR_TIME_YEAR = 593,
        TOK_VARIABLE = 594,
        TOK_DICT_ELEMENT = 595,
        TOK_DICT_ELEMENT_REGEXP = 596
      };
    };
...
switch (yytype)
  ...
  seclang_parser::yytranslate_ (token_type t)
  {
    ...
    const unsigned user_token_number_max_ = 596;
...
#line 8153 "seclang-parser.hh" // lalr1.cc:401
