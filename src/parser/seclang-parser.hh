...
#line 375 "seclang-parser.hh" // lalr1.cc:377
...
namespace yy {
#line 452 "seclang-parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOK_VARIABLE_WEB_APP_ID = 337,
        TOK_VARIABLE_STATUS = 338,
        TOK_VARIABLE_IP = 339,
        TOK_VARIABLE_GLOBAL = 340,
        TOK_VARIABLE_TX = 341,
        TOK_VARIABLE_SESSION = 342,
        TOK_VARIABLE_USER = 343,
        TOK_RUN_TIME_VAR_ENV = 344,
        TOK_RUN_TIME_VAR_XML = 345,
        TOK_ACTION_SETVAR = 346,
        TOK_SETVAR_OPERATION_EQUALS = 347,
        TOK_SETVAR_OPERATION_EQUALS_PLUS = 348,
        TOK_SETVAR_OPERATION_EQUALS_MINUS = 349,
        TOK_NOT = 350,
        TOK_CONFIG_DIR_AUDIT_LOG_FMT = 351,
        TOK_JSON = 352,
        TOK_NATIVE = 353,
        TOK_ACTION_CTL_RULE_ENGINE = 354,
        TOK_ACTION_ACCURACY = 355,
        TOK_ACTION_ALLOW = 356,
        TOK_ACTION_APPEND = 357,
        TOK_ACTION_AUDIT_LOG = 358,
        TOK_ACTION_BLOCK = 359,
        TOK_ACTION_CAPTURE = 360,
        TOK_ACTION_CHAIN = 361,
        TOK_ACTION_CTL_AUDIT_ENGINE = 362,
        TOK_ACTION_CTL_AUDIT_LOG_PARTS = 363,
        TOK_ACTION_CTL_BDY_JSON = 364,
        TOK_ACTION_CTL_BDY_XML = 365,
        TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 366,
        TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 367,
        TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 368,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 369,
        TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 370,
        TOK_ACTION_DENY = 371,
        TOK_ACTION_DEPRECATE_VAR = 372,
        TOK_ACTION_DROP = 373,
        TOK_ACTION_EXEC = 374,
        TOK_ACTION_EXPIRE_VAR = 375,
        TOK_ACTION_ID = 376,
        TOK_ACTION_INITCOL = 377,
        TOK_ACTION_LOG = 378,
        TOK_ACTION_LOG_DATA = 379,
        TOK_ACTION_MATURITY = 380,
        TOK_ACTION_MSG = 381,
        TOK_ACTION_MULTI_MATCH = 382,
        TOK_ACTION_NO_AUDIT_LOG = 383,
        TOK_ACTION_NO_LOG = 384,
        TOK_ACTION_PASS = 385,
        TOK_ACTION_PAUSE = 386,
        TOK_ACTION_PHASE = 387,
        TOK_ACTION_PREPEND = 388,
        TOK_ACTION_PROXY = 389,
        TOK_ACTION_REDIRECT = 390,
        TOK_ACTION_REV = 391,
        TOK_ACTION_SANATISE_ARG = 392,
        TOK_ACTION_SANATISE_MATCHED = 393,
        TOK_ACTION_SANATISE_MATCHED_BYTES = 394,
        TOK_ACTION_SANATISE_REQUEST_HEADER = 395,
        TOK_ACTION_SANATISE_RESPONSE_HEADER = 396,
        TOK_ACTION_SETENV = 397,
        TOK_ACTION_SETRSC = 398,
        TOK_ACTION_SETSID = 399,
        TOK_ACTION_SETUID = 400,
        TOK_ACTION_SEVERITY = 401,
        TOK_ACTION_SKIP = 402,
        TOK_ACTION_SKIP_AFTER = 403,
        TOK_ACTION_STATUS = 404,
        TOK_ACTION_TAG = 405,
        TOK_ACTION_TRANSFORMATION_BASE_64_ENCODE = 406,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE = 407,
        TOK_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 408,
        TOK_ACTION_TRANSFORMATION_CMD_LINE = 409,
        TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 410,
        TOK_ACTION_TRANSFORMATION_CSS_DECODE = 411,
        TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 412,
        TOK_ACTION_TRANSFORMATION_HEX_DECODE = 413,
        TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 414,
        TOK_ACTION_TRANSFORMATION_JS_DECODE = 415,
        TOK_ACTION_TRANSFORMATION_LENGTH = 416,
        TOK_ACTION_TRANSFORMATION_LOWERCASE = 417,
        TOK_ACTION_TRANSFORMATION_MD5 = 418,
        TOK_ACTION_TRANSFORMATION_NONE = 419,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH = 420,
        TOK_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 421,
        TOK_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 422,
        TOK_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 423,
        TOK_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 424,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 425,
        TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 426,
        TOK_ACTION_TRANSFORMATION_REMOVE_NULLS = 427,
        TOK_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 428,
        TOK_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 429,
        TOK_ACTION_TRANSFORMATION_REPLACE_NULLS = 430,
        TOK_ACTION_TRANSFORMATION_SHA1 = 431,
        TOK_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 432,
        TOK_ACTION_TRANSFORMATION_TRIM = 433,
        TOK_ACTION_TRANSFORMATION_UPPERCASE = 434,
        TOK_ACTION_TRANSFORMATION_URL_DECODE = 435,
        TOK_ACTION_TRANSFORMATION_URL_DECODE_UNI = 436,
        TOK_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 437,
        TOK_ACTION_VER = 438,
        TOK_ACTION_XMLNS = 439,
        TOK_CONFIG_COMPONENT_SIG = 440,
        TOK_CONFIG_SEC_ARGUMENT_SEPARATOR = 441,
        TOK_CONFIG_SEC_WEB_APP_ID = 442,
        TOK_CONFIG_SEC_SERVER_SIG = 443,
        TOK_CONFIG_DIR_AUDIT_DIR = 444,
        TOK_CONFIG_DIR_AUDIT_DIR_MOD = 445,
        TOK_CONFIG_DIR_AUDIT_ENG = 446,
        TOK_CONFIG_DIR_AUDIT_FLE_MOD = 447,
        TOK_CONFIG_DIR_AUDIT_LOG = 448,
        TOK_CONFIG_DIR_AUDIT_LOG2 = 449,
        TOK_CONFIG_DIR_AUDIT_LOG_P = 450,
        TOK_CONFIG_DIR_AUDIT_STS = 451,
        TOK_CONFIG_DIR_AUDIT_TPE = 452,
        TOK_CONFIG_DIR_DEBUG_LOG = 453,
        TOK_CONFIG_DIR_DEBUG_LVL = 454,
        TOK_CONFIG_SEC_CACHE_TRANSFORMATIONS = 455,
        TOK_CONFIG_DIR_GEO_DB = 456,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 457,
        TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 458,
        TOK_CONFIG_DIR_REQ_BODY = 459,
        TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 460,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT = 461,
        TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 462,
        TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 463,
        TOK_CONFIG_DIR_RES_BODY = 464,
        TOK_CONFIG_DIR_RES_BODY_LIMIT = 465,
        TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 466,
        TOK_CONFIG_DIR_RULE_ENG = 467,
        TOK_CONFIG_DIR_SEC_ACTION = 468,
        TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 469,
        TOK_CONFIG_DIR_SEC_MARKER = 470,
        TOK_CONFIG_DIR_UNICODE_MAP_FILE = 471,
        TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 472,
        TOK_CONFIG_SEC_HTTP_BLKEY = 473,
        TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 474,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 475,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 476,
        TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 477,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 478,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 479,
        TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 480,
        TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 481,
        TOK_CONFIG_UPDLOAD_KEEP_FILES = 482,
        TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 483,
        TOK_CONFIG_UPLOAD_DIR = 484,
        TOK_CONFIG_UPLOAD_FILE_LIMIT = 485,
        TOK_CONFIG_UPLOAD_FILE_MODE = 486,
        TOK_CONFIG_VALUE_ABORT = 487,
        TOK_CONFIG_VALUE_DETC = 488,
        TOK_CONFIG_VALUE_HTTPS = 489,
        TOK_CONFIG_VALUE_OFF = 490,
        TOK_CONFIG_VALUE_ON = 491,
        TOK_CONFIG_VALUE_PARALLEL = 492,
        TOK_CONFIG_VALUE_PROCESS_PARTIAL = 493,
        TOK_CONFIG_VALUE_REJECT = 494,
        TOK_CONFIG_VALUE_RELEVANT_ONLY = 495,
        TOK_CONFIG_VALUE_SERIAL = 496,
        TOK_CONFIG_VALUE_WARN = 497,
        TOK_CONFIG_XML_EXTERNAL_ENTITY = 498,
        TOK_CONGIG_DIR_RESPONSE_BODY_MP = 499,
        TOK_CONGIG_DIR_SEC_ARG_SEP = 500,
        TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 501,
        TOK_CONGIG_DIR_SEC_DATA_DIR = 502,
        TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 503,
        TOK_CONGIG_DIR_SEC_TMP_DIR = 504,
        TOK_DIRECTIVE = 505,
        TOK_DIRECTIVE_SECRULESCRIPT = 506,
        TOK_FREE_TEXT = 507,
        TOK_OPERATOR = 508,
        TOK_OPERATOR_BEGINS_WITH = 509,
        TOK_OPERATOR_CONTAINS = 510,
        TOK_OPERATOR_CONTAINS_WORD = 511,
        TOK_OPERATOR_DETECT_SQLI = 512,
        TOK_OPERATOR_DETECT_XSS = 513,
        TOK_OPERATOR_ENDS_WITH = 514,
        TOK_OPERATOR_EQ = 515,
        TOK_OPERATOR_FUZZY_HASH = 516,
        TOK_OPERATOR_GE = 517,
        TOK_OPERATOR_GEOLOOKUP = 518,
        TOK_OPERATOR_GSB_LOOKUP = 519,
        TOK_OPERATOR_GT = 520,
        TOK_OPERATOR_INSPECT_FILE = 521,
        TOK_OPERATOR_IP_MATCH = 522,
        TOK_OPERATOR_IP_MATCH_FROM_FILE = 523,
        TOK_OPERATOR_LE = 524,
        TOK_OPERATOR_LT = 525,
        TOK_OPERATOR_PM = 526,
        TOK_OPERATOR_PM_FROM_FILE = 527,
        TOK_OPERATOR_RBL = 528,
        TOK_OPERATOR_RSUB = 529,
        TOK_OPERATOR_RX = 530,
        TOK_OPERATOR_RX_CONTENT_ONLY = 531,
        TOK_OPERATOR_STR_EQ = 532,
        TOK_OPERATOR_STR_MATCH = 533,
        TOK_OPERATOR_UNCONDITIONAL_MATCH = 534,
        TOK_OPERATOR_VALIDATE_BYTE_RANGE = 535,
        TOK_OPERATOR_VALIDATE_DTD = 536,
        TOK_OPERATOR_VALIDATE_HASH = 537,
        TOK_OPERATOR_VALIDATE_SCHEMA = 538,
        TOK_OPERATOR_VALIDATE_URL_ENCODING = 539,
        TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 540,
        TOK_OPERATOR_VERIFY_CC = 541,
        TOK_OPERATOR_VERIFY_CPF = 542,
        TOK_OPERATOR_VERIFY_SSN = 543,
        TOK_OPERATOR_WITHIN = 544,
        TOK_OP_QUOTE = 545,
        TOK_QUOTATION_MARK = 546,
        TOK_RUN_TIME_VAR_BLD = 547,
        TOK_RUN_TIME_VAR_DUR = 548,
        TOK_RUN_TIME_VAR_HSV = 549,
        TOK_RUN_TIME_VAR_REMOTE_USER = 550,
        TOK_RUN_TIME_VAR_TIME = 551,
        TOK_RUN_TIME_VAR_TIME_DAY = 552,
        TOK_RUN_TIME_VAR_TIME_EPOCH = 553,
        TOK_RUN_TIME_VAR_TIME_HOUR = 554,
        TOK_RUN_TIME_VAR_TIME_MIN = 555,
        TOK_RUN_TIME_VAR_TIME_MON = 556,
        TOK_RUN_TIME_VAR_TIME_SEC = 557,
        TOK_RUN_TIME_VAR_TIME_WDAY = 558,
        TOK_RUN_TIME_VAR_TIME_YEAR = 559,
        TOK_SETVAR_VARIABLE_PART = 560,
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 1119,     ///< Last index in yytable_.
      yynnts_ = 16,  ///< Number of nonterminal symbols.
      yyfinal_ = 290, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
...
#line 5867 "seclang-parser.hh" // lalr1.cc:377
