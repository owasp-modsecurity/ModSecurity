...
## English
This directory is reserved for optional vendored sources for backend jsoncons.
Use system packages when available; use bundled sources as fallback.

## Deutsch
Dieses Verzeichnis ist für optionale vendorte Quellen des Backends jsoncons reserviert.
