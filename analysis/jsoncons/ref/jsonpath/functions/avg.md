# Analyse: others/jsoncons/doc/ref/jsonpath/functions/avg.md
...
- Relevante Klassen/Funktionen/Symbole: avg
...
- Das Symbol bzw. der Begriff `avg` kommt in `others/jsoncons/include/jsoncons_ext/jmespath/jmespath.hpp` vor.
- Das Symbol bzw. der Begriff `avg` kommt in `others/jsoncons/include/jsoncons_ext/jsonpath/token_evaluator.hpp` vor.
