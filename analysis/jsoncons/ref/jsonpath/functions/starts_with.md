# Analyse: others/jsoncons/doc/ref/jsonpath/functions/starts_with.md
...
- Relevante Klassen/Funktionen/Symbole: starts_with
...
- Das Symbol bzw. der Begriff `starts_with` kommt in `others/jsoncons/include/jsoncons_ext/jmespath/jmespath.hpp` vor.
- Das Symbol bzw. der Begriff `starts_with` kommt in `others/jsoncons/include/jsoncons_ext/jsonpath/token_evaluator.hpp` vor.
- Das Symbol bzw. der Begriff `starts_with` kommt in `others/jsoncons/include/jsoncons_ext/toon/toon_reader.hpp` vor.
- Das Symbol bzw. der Begriff `starts_with` kommt in `others/jsoncons/include/jsoncons/utility/string_utils.hpp` vor.
...
- Es gibt einen zugeordneten Test-/Beispiel-/Benchmark-Treffer in `others/jsoncons/test/corelib/src/utility/string_utils_tests.cpp`.
