# Analyse: others/jsoncons/doc/ref/jsonpath/functions/tokenize.md
...
- Relevante Klassen/Funktionen/Symbole: tokenize
...
- Das Symbol bzw. der Begriff `tokenize` kommt in `others/jsoncons/include/jsoncons_ext/jsonpath/token_evaluator.hpp` vor.
