# Analyse: others/jsoncons/doc/ref/jsonpath/jsonpath_expression/select.md
...
- Relevante Klassen/Funktionen/Symbole: jsoncons::jsonpath::jsonpath_expression::select, select, Receive locations and values selected from a root value (since 0.172.0)
...
- others/jsoncons/include/jsoncons_ext/jsonpath/jsonpath_selector.hpp
- others/jsoncons/test/jsonpath/src
- Symbole: jsoncons::jsonpath::jsonpath_expression::select, select, Receive locations and values selected from a root value (since 0.172.0)
