# Analyse: others/jsoncons/doc/ref/corelib/conv_error.md
...
- Relevante Klassen/Funktionen/Symbole: jsoncons::conv_error, conv_error, Inherited from std::system_error, system_error
...
- Der in der Doku verwendete Header `jsoncons/conv_error.hpp` ist im Repository unter `others/jsoncons/include/jsoncons/conv_error.hpp` vorhanden.
...
- Das Symbol bzw. der Begriff `conv_error` kommt in `others/jsoncons/include/jsoncons/basic_json.hpp` vor.
- Das Symbol bzw. der Begriff `conv_error` kommt in `others/jsoncons/include/jsoncons/conv_error.hpp` vor.
- Das Symbol bzw. der Begriff `conv_error` kommt in `others/jsoncons/include/jsoncons/conversion_result.hpp` vor.
- Das Symbol bzw. der Begriff `conv_error` kommt in `others/jsoncons/include/jsoncons/decode_json.hpp` vor.
...
- others/jsoncons/include/jsoncons/json.hpp
- others/jsoncons/test/corelib/src
- Symbole: jsoncons::conv_error, conv_error, Inherited from std::system_error, system_error
