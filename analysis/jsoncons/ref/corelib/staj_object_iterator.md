# Analyse: others/jsoncons/doc/ref/corelib/staj_object_iterator.md

## Zugehörige Implementierung
- others/jsoncons/include/jsoncons/staj_iterator.hpp
- others/jsoncons/test/corelib/src
- Relevante Klassen/Funktionen/Symbole: jsoncons::staj_object_iterator, staj_object_iterator
...
- Der in der Doku verwendete Header `jsoncons/staj_iterator.hpp` ist im Repository unter `others/jsoncons/include/jsoncons/staj_iterator.hpp` vorhanden.
...
- Das Symbol bzw. der Begriff `staj_object_iterator` kommt in `others/jsoncons/include/jsoncons/staj_iterator.hpp` vor.
...
- Es gibt einen zugeordneten Test-/Beispiel-/Benchmark-Treffer in `others/jsoncons/test/corelib/src/staj_iterator_tests.cpp`.
...
- others/jsoncons/include/jsoncons/staj_iterator.hpp
- others/jsoncons/test/corelib/src
- Symbole: jsoncons::staj_object_iterator, staj_object_iterator
