# Analyse: others/jsoncons/doc/ref/cbor/basic_cbor_cursor.md
...
- Relevante Klassen/Funktionen/Symbole: jsoncons::cbor::basic_cbor_cursor, basic_cbor_cursor
...
- Der in der Doku verwendete Header `jsoncons_ext/cbor/cbor_cursor.hpp` ist im Repository unter `others/jsoncons/include/jsoncons_ext/cbor/cbor_cursor.hpp` vorhanden.
...
- Das Symbol bzw. der Begriff `basic_cbor_cursor` kommt in `others/jsoncons/include/jsoncons_ext/cbor/cbor_cursor.hpp` vor.
...
- others/jsoncons/include/jsoncons_ext/cbor/decode_cbor.hpp
- others/jsoncons/test/cbor/src
- Symbole: jsoncons::cbor::basic_cbor_cursor, basic_cbor_cursor
