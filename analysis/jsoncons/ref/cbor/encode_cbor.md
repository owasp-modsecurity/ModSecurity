# Analyse: others/jsoncons/doc/ref/cbor/encode_cbor.md
...
- others/jsoncons/test/cbor/src/cbor_cursor_tests.cpp
- others/jsoncons/test/cbor/src/cbor_encoder_tests.cpp
- others/jsoncons/test/cbor/src/cbor_event_reader_tests.cpp
- others/jsoncons/test/cbor/src
- Relevante Klassen/Funktionen/Symbole: jsoncons::cbor::encode_cbor, encode_cbor
...
- Das Symbol bzw. der Begriff `encode_cbor` kommt in `others/jsoncons/include/jsoncons_ext/cbor/cbor.hpp` vor.
- Das Symbol bzw. der Begriff `encode_cbor` kommt in `others/jsoncons/include/jsoncons_ext/cbor/encode_cbor.hpp` vor.
- Das Symbol bzw. der Begriff `encode_cbor` kommt in `others/jsoncons/test/CMakeLists.txt` vor.
...
- others/jsoncons/test/cbor/src/cbor_event_reader_tests.cpp
- others/jsoncons/test/cbor/src
- Symbole: jsoncons::cbor::encode_cbor, encode_cbor
