# Analyse: others/jsoncons/doc/ref/jsonschema/walk_result.md

## Zugehörige Implementierung
- others/jsoncons/include/jsoncons_ext/jsonschema/common/format.hpp
...
- Relevante Klassen/Funktionen/Symbole: jsoncons::jsonschema::walk_result, walk_result
...
- Das Symbol bzw. der Begriff `walk_result` kommt in `others/jsoncons/include/jsoncons_ext/jsonschema/json_schema.hpp` vor.
- Das Symbol bzw. der Begriff `walk_result` kommt in `others/jsoncons/include/jsoncons_ext/jsonschema/common/format.hpp` vor.
- Das Symbol bzw. der Begriff `walk_result` kommt in `others/jsoncons/include/jsoncons_ext/jsonschema/common/keyword_validator.hpp` vor.
- Das Symbol bzw. der Begriff `walk_result` kommt in `others/jsoncons/include/jsoncons_ext/jsonschema/common/schema_validator.hpp` vor.
...
- others/jsoncons/test/jsonschema/src/dynamic_ref_tests.cpp
- others/jsoncons/test/jsonschema/src
- Symbole: jsoncons::jsonschema::walk_result, walk_result
