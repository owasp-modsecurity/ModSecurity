# Analyse: others/jsoncons/doc/ref/mergepatch/mergepatch.md
...
- Relevante Klassen/Funktionen/Symbole: mergepatch
...
- Das Symbol bzw. der Begriff `mergepatch` kommt in `others/jsoncons/include/jsoncons_ext/mergepatch/mergepatch.hpp` vor.
- Das Symbol bzw. der Begriff `mergepatch` kommt in `others/jsoncons/test/CMakeLists.txt` vor.
- Das Symbol bzw. der Begriff `mergepatch` kommt in `others/jsoncons/test/mergepatch/src/mergepatch_test_suite.cpp` vor.
