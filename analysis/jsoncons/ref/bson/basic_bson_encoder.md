# Analyse: others/jsoncons/doc/ref/bson/basic_bson_encoder.md
...
- Relevante Klassen/Funktionen/Symbole: jsoncons::bson::basic_bson_encoder, basic_bson_encoder, Destructor
...
- Der in der Doku verwendete Header `jsoncons_ext/bson/bson_encoder.hpp` ist im Repository unter `others/jsoncons/include/jsoncons_ext/bson/bson_encoder.hpp` vorhanden.
...
- Das Symbol bzw. der Begriff `basic_bson_encoder` kommt in `others/jsoncons/include/jsoncons_ext/bson/bson_encoder.hpp` vor.
...
- others/jsoncons/include/jsoncons_ext/bson/encode_bson.hpp
- others/jsoncons/test/bson/src
- Symbole: jsoncons::bson::basic_bson_encoder, basic_bson_encoder, Destructor
