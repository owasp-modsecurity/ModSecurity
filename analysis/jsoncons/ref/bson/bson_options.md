# Analyse: others/jsoncons/doc/ref/bson/bson_options.md
...
- others/jsoncons/include/jsoncons_ext/bson/decode_bson.hpp
- others/jsoncons/test/bson/src
- Relevante Klassen/Funktionen/Symbole: jsoncons::bson::bson_options, bson_options, Modifiers
...
- Der in der Doku verwendete Header `jsoncons_ext/bson/bson_options.hpp` ist im Repository unter `others/jsoncons/include/jsoncons_ext/bson/bson_options.hpp` vorhanden.
...
- Das Symbol bzw. der Begriff `bson_options` kommt in `others/jsoncons/include/jsoncons_ext/bson/bson_cursor.hpp` vor.
...
- Es gibt einen zugeordneten Test-/Beispiel-/Benchmark-Treffer in `others/jsoncons/test/bson/src/bson_encoder_tests.cpp`.
...
- others/jsoncons/include/jsoncons_ext/bson/decode_bson.hpp
- others/jsoncons/test/bson/src
- Symbole: jsoncons::bson::bson_options, bson_options, Modifiers
