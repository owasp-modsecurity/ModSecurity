...
@pytest.mark.parametrize("input_data,expected_output,expected_ret,test_name", [
    ...
    (b'  Test  \t   Case  ', b'TestCase', 1, 'Test case 4'),
    (b'This is a   test case with a tab \t, vtab \x0b, newline \n, return \r, formfeed \x0c, and a NUL\x00 in it with a CRLF at the end.\r\n', b'Thisisatestcasewithatab,vtab,newline,return,formfeed,andaNUL\x00initwithaCRLFattheend.', 1, 'Test case 5'),
])
def test_removewhitespace_transformation(unit_test, input_data, expected_output, expected_ret, test_name):
    """Test the removeWhitespace transformation with various inputs"""
