...
@pytest.mark.parametrize("input_data,expected_output,expected_ret,test_name", [
    (b'', b'', 0, 'Test case 1'),
    (b'/foo/bar/baz', b'/foo/bar/baz', 0, 'Test case 2'),
    (b'/foo/bar\x00/baz', b'/foo/bar\x00/baz', 0, 'Test case 3'),
...
def test_normalisepath_transformation(unit_test, input_data, expected_output, expected_ret, test_name):
    """Test the normalisePath transformation with various inputs"""
