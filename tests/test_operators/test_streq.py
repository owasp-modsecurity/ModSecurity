...
@pytest.mark.parametrize("param,input_data,expected_ret,test_name", [
    ...
    (b'abcdefghi', b'abcdefghi', 1, 'Test case 7'),
])
def test_streq_operator(unit_test, param, input_data, expected_ret, test_name):
    """Test the @streq operator with various inputs"""
